...
/*jshint ignore:start*/
(function() {
    function ma(k, m) { k.prototype = ab(m.prototype);
    ...
    function $(k, m) { var w = !1;
        0 > k && (w = !0, k *= -1);
        k = "" + k; for (m = m ? m : 1; k.length < m;) k = "0" + k; return w ? "-" + k : k }

    function Da(k) { if (!k) return k;
        k = k.replace(/^\s\s*/, ""); for (var m = /\s/, w = k.length; m.test(k.charAt(--w));); return k.slice(0, w + 1) }
    ...
    function P(k) { var m = ((k & 16711680) >> 16).toString(16),
        ...
        m = 2 > m.length ? "0" + m : m;
        w = 2 > w.length ? "0" + w : w;
        k = 2 > k.length ? "0" + k : k; return "#" + m + w + k }
    ...
    function Aa(k) { k.indexOf || (k.indexOf = bb); return k }

    function cb(k) { if (J.fSDec) k[Y("`eeDwdouMhrudods")](Y("e`u`@ohl`uhnoHuds`uhnoDoe"), function() { J._fTWm && J._fTWm(k) }) }
        ...
        if (isNaN(u)) {
            try {
                k = "position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:" +
                    k + "; font-size:" + m + "px; font-weight:" + w + ";";
                if (!ua) { var pa = document.body;
                    ua = document.createElement("span");
                    ua.innerHTML = ""; var D = document.createTextNode("Mpgyi");
                    ua.appendChild(D);
                    pa.appendChild(ua) }
                ua.style.display = "";
    ...
    function V(k, m, w, u, y) {
        ...
        u.push([k, m, w, y]);
        return k.addEventListener ? (k.addEventListener(m, w, y), w) : k.attachEvent ? (u = function(m) { m = m || window.event;
            m.preventDefault = m.preventDefault || function() { m.returnValue = !1 };
            m.stopPropagation = m.stopPropagation || function() { m.cancelBubble = !0 };
            w.call(k, m) }, k.attachEvent("on" +
            m, u), u) : !1
    }
    ...
    function eb(k) {
        if (k._menuButton) k.exportEnabled ? Ia(k._menuButton) : sa(k._menuButton);
            ...
            V(k._menuButton, "mouseover", function() { m || (na(k, k._menuButton, { backgroundColor: k.toolbar.backgroundColorOnHover, color: k.toolbar.fontColorOnHover }), 0 >= navigator.userAgent.search("MSIE") && na(k, k._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, k.allDOMEventHandlers, !0);
        ...
        if (!k._dropdownMenu && k.exportEnabled && u) {
            ...
            k._dropdownMenu.style.cssText = "position: absolute; z-index: 1; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 120px;outline: 0;font-size: 14px; font-family: Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;text-align: left;line-height: 10px;background-color:" +
                k.toolbar.backgroundColor + ";box-shadow: 2px 2px 10px " + w;
            k._dropdownMenu.style.display = "none";
            k._toolBar.appendChild(k._dropdownMenu);
            V(k._dropdownMenu, "blur", function() { sa(k._dropdownMenu);
            ...
            V(w, "touchstart", function(k) {
                m = !0
            }, k.allDOMEventHandlers);
            V(w, "mouseover", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColorOnHover, this.style.color = k.toolbar.fontColorOnHover) }, k.allDOMEventHandlers, !0);
            V(w, "mouseout", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0);
            V(w, "click", function() { k.print();
                sa(k._dropdownMenu) }, k.allDOMEventHandlers, !0);
            w = document.createElement("div");
            w.style.cssText = "padding: 12px 8px 12px 8px";
            w.innerHTML =
            ...
            w.style.color = k.toolbar.fontColor;
            k._dropdownMenu.appendChild(w);
            V(w, "touchstart", function(k) { m = !0 }, k.allDOMEventHandlers);
            V(w, "mouseover", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColorOnHover, this.style.color = k.toolbar.fontColorOnHover) }, k.allDOMEventHandlers, !0);
            V(w, "mouseout", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0);
            V(w, "click", function() { k.exportChart({ format: "jpeg", fileName: k.exportFileName });
                sa(k._dropdownMenu) }, k.allDOMEventHandlers, !0);
            w = document.createElement("div");
            w.style.cssText = "padding: 12px 8px 12px 8px";
    ...
    function Wa(k, m, w) {
        ...
        m = !0;
        for (w = 0; 4 > w; w++)
            if (k[w] !== k[w + 4] | k[w] !== k[w + 8] | k[w] !== k[w + 12]) { m = !1; break }
        return m ? k[0] <<
            16 | k[1] << 8 | k[2] : 0
    }

    function ka(k, m, w) { return k in m ? m[k] : w[k] }

    function Ja(k, m, w) { if (u && Xa) { var s = k.getContext("2d");
            Ka = s.webkitBackingStorePixelRatio || s.mozBackingStorePixelRatio || s.msBackingStorePixelRatio || s.oBackingStorePixelRatio || s.backingStorePixelRatio || 1;
            ga = Oa / Ka;
            k.width = m * ga;
            k.height = w * ga;
            Oa !== Ka && (k.style.width = m + "px", k.style.height = w + "px", s.scale(ga, ga)) } else k.width = m, k.height = w }

    function fb(k) {
        if (!gb) {
            var m = !1,
                w = !1;
            "undefined" === typeof oa.Chart.creditHref ? (k.creditHref = Y("iuuqr;..b`ow`rkr/bnl."),
                k.creditText = Y("B`ow`rKR/bnl")) : (m = k.updateOption("creditText"), w = k.updateOption("creditHref"));
            if (k.creditHref && k.creditText) {
                ...
                if (0 === k.renderCount || m || w) k._creditLink.setAttribute("href", k.creditHref), k._creditLink.innerHTML = k.creditText;
    ...
    function na(k, m, w) { for (var s in w) m.style[s] = w[s] }

    function ta(k, m, w) {
        m.getAttribute("state") || (m.style.backgroundColor = k.toolbar.backgroundColor, m.style.color = k.toolbar.fontColor, m.style.border = "none", na(k, m, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
    ...
    function Ia() { for (var k = null, m = 0; m < arguments.length; m++) k = arguments[m], k.style && (k.style.display = "inline") }
    ...
    function Pa(k, m, w, s, u) { if (null === k || "undefined" === typeof k) return "undefined" === typeof w ? m : w;
        k = parseFloat(k.toString()) * (0 <= k.toString().indexOf("%") ? m / 100 : 1); "undefined" !== typeof s && (k = Math.min(s, k), "undefined" !== typeof u && (k = Math.max(u, k))); return !isNaN(k) && k <= m && 0 <= k ? k : "undefined" === typeof w ? m : w }
    ...
    function Qa(k, m) { Qa.base.constructor.call(this, "Toolbar", "toolbar", m, null, k);
        this.chart = k;
    ...
    function Fa(k, m, w) { Fa.base.constructor.call(this, "Subtitle", "subtitles", m, w, k);
        this.chart = k;
        this.canvas = k.canvas;
        this.ctx = this.chart.ctx;
    ...
    var Ea = !1,
        ...
        Ca = u ? "Impact, Charcoal, sans-serif" :
        "Arial",
        xa = { colorSet1: "#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "), colorSet2: "#6D78AD #51CDA0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C".split(" "), colorSet3: "#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ") },
        I, aa, T, da, ha;
    aa = "#333333";
    T = "#000000";
    I = "#666666";
    ...
    var U = 20,
        ...
        Sa = {
            ...
            title: { fontFamily: Ca, fontSize: 32, fontColor: aa, fontWeight: "normal", verticalAlign: "top", margin: 5 },
            subtitles: [{ fontFamily: Ca, fontSize: E, fontColor: aa, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
    ...
    (function() {
        J.fSDec = function(k) { for (var m = "", w = 0; w < k.length; w++) m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(w)); return m };
        J.obj = {
            trVs: "Ush`m!Wdsrhno",
        ...
        J._fTWm = function(k) { if ("undefined" === typeof J.pro.sCH && !$a) try { var m = k[J.fSDec(J.obj.cntx)];
                m[J.fSDec(J.obj.txtBl)] = J.fSDec(J.obj.tp);
                m[J.fSDec(J.obj.fnt)] = 11 + J.fSDec(J.obj.fntStr);
                m[J.fSDec(J.obj.fSy)] = J.fSDec(J.obj.grClr);
                m[J.fSDec(J.obj.fTx)](J.fSDec(J.obj.trVs), 2, k.height - 11 - 2) } catch (w) {} }
    })();
    var db = function() {
            var k = !1;
            try { var m = Object.defineProperty && Object.defineProperty({}, "passive", { get: function() { k = !0; return !1 } });
                window.addEventListener && (window.addEventListener("test", null, m), window.removeEventListener("test", null, m)) } catch (w) { k = !1 }
            return k
        }(),
        Va = {},
        ua = null,
        ib = function() { this.ctx.clearRect(0, 0, this.width, this.height);
            this.backgroundColor && (this.ctx.fillStyle = this.backgroundColor, this.ctx.fillRect(0, 0, this.width, this.height)) },
        jb = function(k, m, w) {
            m = Math.min(this.width, this.height);
            return Math.max("theme4" ===
            ...
            for (Q = E = L = J = N = 0; 0 < M.length;)
                if (m = M.pop(), "#" === m || "0" === m)
                    if (N++, N === P) {
                        ...
                        for (; 0 < X.length;) w = X.pop() + w, Q++, 0 === Q % E && (L === V && 0 < X.length) && (w = y + w)
                    } else 0 < D.length ? (w = D.pop() + w, J++, Q++) : "0" === m && (w = "0" + w, J++, Q++), 0 === Q % E && (L === V && 0 < D.length) && (w = y + w);
            else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (L++, E = Q, Q = 0, 0 < D.length && (w = y + w)) : w = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + w : m + w : (m = 0 > W ? m.replace("+", "").replace("-",
                "") : m.replace("-", ""), w += m.replace(/[0]+/, function(a) { return $(W, a.length) }));
            y = "";
        ...
        La = function(k) { var m = 0,
                w = 0;
            k = k || window.event;
            k.offsetX || 0 === k.offsetX ? (m = k.offsetX, w = k.offsetY) : k.layerX || 0 == k.layerX ? (m = k.layerX, w = k.layerY) : (m = k.pageX - k.target.offsetLeft, w = k.pageY - k.target.offsetTop); return { x: m, y: w } },
        Xa = !0,
        ...
        ca = function(k, m, w, s, u, y, D, E, N, M, Q, P, I) {
            ...
            k.globalAlpha = 1;
            0 < D && (I = 0 === D % 2 ? 0 : 0.5, k.beginPath(), k.lineWidth = D, k.strokeStyle = E, k.moveTo(m, w), k.rect(m - I, w - I, s - m + 2 * I, u - w + 2 * I), k.stroke());
            k.restore();
            !0 === N && (k.save(), k.beginPath(), k.moveTo(m, w), k.lineTo(m + J, w + J), k.lineTo(s - J, w + J), k.lineTo(s, w), k.closePath(), D = k.createLinearGradient((s + m) / 2, w + J, (s + m) / 2, w), D.addColorStop(0, y), D.addColorStop(1, "rgba(255, 255, 255, .4)"), k.fillStyle = D, k.fill(), k.restore());
            ...
            !0 === Q && (k.save(), k.beginPath(), k.moveTo(m, w), k.lineTo(m + J, w + J), k.lineTo(m + J, u - J), k.lineTo(m, u), k.closePath(), D = k.createLinearGradient(m + J, (u + w) / 2, m, (u + w) / 2), D.addColorStop(0, y), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), k.fillStyle = D, k.fill(), k.restore());
        ...
        Y = function(k) { for (var m = "", s = 0; s < k.length; s++) m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(s)); return m },
        $a = window && window[Y("mnb`uhno")] && window[Y("mnb`uhno")].href && window[Y("mnb`uhno")].href.indexOf && (-1 !==
    ...
    W.prototype.setOptions = function(k, m) { if (oa[this._defaultsKey]) { var s = oa[this._defaultsKey],
                u; for (u in s) "publicProperties" !== u && s.hasOwnProperty(u) && (this[u] = k && u in k ? k[u] : m && u in m ? m[u] : s[u]) } else Ea && window.console && console.log("defaults not set") };
    ...
    W.prototype.remove = function(k) { k = "undefined" === typeof k ? !0 : k; if (this.isOptionsInArray) { var m = this.parent.options[this.optionsName];
            Aa(m); var s = m.indexOf(this.options);
    ...
    W.prototype.updateOption = function(k) {
        !oa[this._defaultsKey] && (Ea && window.console) && console.log("defaults not set");
        var m = oa[this._defaultsKey],
            u = {},
            y = this[k],
    ...
    Ba.prototype.registerSpace = function(k, m) { "top" === k ? this._topOccupied += m.height : "bottom" === k ? this._bottomOccupied += m.height : "left" === k ? this._leftOccupied += m.width : "right" === k && (this._rightOccupied += m.width) };
    Ba.prototype.unRegisterSpace = function(k, m) { "top" === k ? this._topOccupied -= m.height : "bottom" === k ? this._bottomOccupied -= m.height : "left" === k ? this._leftOccupied -= m.width : "right" === k && (this._rightOccupied -= m.width) };
    Ba.prototype.getFreeSpace =
    ...
    Ba.prototype.reset = function() { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding };
    ma(ia, W);
    ...
    ia.prototype.render = function(k) {
        if (0 !== this.fontSize) {
            ...
            for (s = 0; s < this._wrappedText.lines.length; s++) E =
                this._wrappedText.lines[s], "right" === this.horizontalAlign ? u = this.width - E.width - this.rightPadding : "left" === this.horizontalAlign ? u = this.leftPadding : "center" === this.horizontalAlign && (u = (this.width - (this.leftPadding + this.rightPadding)) / 2 - E.width / 2 + this.leftPadding), this.ctx.fillText(E.text, u, y), y += E.height;
            this.ctx.font = m;
            k && this.ctx.restore()
        }
    };
    ia.prototype.setText = function(k) { this.text = k;
        this._isDirty = !0;
        this._wrappedText = null };
    ...
    ia.prototype._getLineWithWidth = function(k, m, s) {
        ...
        var u = s = 0,
            y = k.length - 1,
            E = Infinity;
        for (this.ctx.font = this._getFontString(); u <= y;) { var E = Math.floor((u + y) / 2),
                D = k.substr(0, E + 1);
            s = this.ctx.measureText(D).width; if (s < m) u = E + 1;
            else if (s > m) y = E - 1;
            else break }
        s > m && 1 < D.length && (D =
            D.substr(0, D.length - 1), s = this.ctx.measureText(D).width);
        m = !0;
        ...
        if (0 === this.frontSize) y = u = 0;
            ...
            for (; 0 < k.length;) {
                var E = this.maxHeight - (this.topPadding + this.bottomPadding),
                    D = this._getLineWithWidth(k, this.maxWidth -
    ...
    wa.prototype.render = function() { this._textBlock && this._textBlock.render(!0) };
    ma(Fa, W);
    Fa.prototype.setLayout = wa.prototype.setLayout;
    Fa.prototype.render = wa.prototype.render;
    Ra.prototype.get = function(k, m) {
        var u = null;
        0 < this.pool.length ? (u = this.pool.pop(), Ja(u, k,
            m)) : u = ra(k, m);
        return u
    };
    Ra.prototype.release = function(k) { this.pool.push(k) };
    ma(Ga, W);
    var Ma = { addTheme: function(k, m) { Za[k] = m }, addColorSet: function(k, m) { xa[k] = m }, addCultureInfo: function(k, m) { Ha[k] = m }, formatNumber: function(k, m, u) { u = u || "en"; if (Ha[u]) return ea(k, m || "#,##0.##", new Ga(u)); throw "Unknown Culture Name"; }, formatDate: function(k, m, u) { u = u || "en"; if (Ha[u]) return ya(k, m || "DD MMM YYYY", new Ga(u)); throw "Unknown Culture Name"; } };
    "undefined" !== typeof module && "undefined" !== typeof module.exports ? module.exports =
        Ma : "function" === typeof define && define.amd ? define([], function() { return Ma }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS : Ma);
    y = Ma.Chart = function() {
        function k(a, d) { return a.x - d.x }

        function m(a, d, c) {
            d = d || {};
            s(c) ? (this.predefinedThemes = Za, this.optionsName = this.parent = this.index = null) : (this.parent =
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ? this.width : 0 < this.container.clientWidth ?
                ...
                "left", this._canvasJSContainer.style.cursor = "auto", this._canvasJSContainer.style.direction = "ltr", u || (this._canvasJSContainer.style.height = "0px"), this.container.appendChild(this._canvasJSContainer), this.canvas = ra(a, d), this._preRenderCanvas = ra(a, d), this.canvas.style.position = "absolute", this.canvas.style.WebkitUserSelect = "none", this.canvas.style.MozUserSelect = "none", this.canvas.style.msUserSelect = "none", this.canvas.style.userSelect = "none", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas),
                    ...
                    V(this.overlaidCanvas, "mousemove", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), V(this.overlaidCanvas, "mouseup", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), V(this.overlaidCanvas, "mousedown", function(a) { b._mouseEventHandler(a);
                        sa(b._dropdownMenu) }, this.allDOMEventHandlers), V(this.overlaidCanvas, "mouseout", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), V(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" : "touchstart", function(a) { b._touchEventHandler(a) },
        ...
        function w(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e) c.push(a[0]);
                    ...
                    b = (a[p].y - a[f].y) /
                        b;
                    c[c.length] = a[l].x > a[f].x && 0 < B || a[l].x < a[f].x && 0 > B ? { x: a[l].x + B / 3, y: a[l].y + b / 3 } : { x: a[l].x, y: a[l].y + b / 9 };
                    l = e;
                    f = 0 === l ? 0 : l - 1;
                    p = l === a.length - 1 ? l : l + 1;
        ...
        function y(a, d, c, b, e, f, p, l, B, h) {
            ...
            n = 0 < p.trimLength ?
                Math.abs(n * p.trimLength / 100) : Math.abs(n - p.length);
            ...
            a.beginPath();
            B && 0 < l.thickness ? (a.moveTo(b - p.thickness / 2, Math.round((c + e) / 2) - r), a.lineTo(d + p.thickness / 2, Math.round((c + e) / 2) - r)) : 0 < l.thickness && (a.moveTo(Math.round((d + b) / 2) - r, c + p.thickness / 2), a.lineTo(Math.round((d +
                b) / 2) - r, e - p.thickness / 2));
            a.stroke();
            a.strokeStyle = p.color || f;
            a.lineWidth = p.thickness || 2;
            a.setLineDash && a.setLineDash(N(p.dashType, p.thickness));
            a.beginPath();
            B && 0 < p.thickness ? (a.moveTo(b - n, c), a.lineTo(b - n, e), a.moveTo(d + n, c), a.lineTo(d + n, e)) : 0 < p.thickness && (a.moveTo(d, c + n), a.lineTo(b, c + n), a.moveTo(d, e - n), a.lineTo(b, e - n));
            a.stroke();
            a.restore()
        }
        ...
        m.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (!this._zoomButton) {
                    ...
                    V(this._zoomButton, "click", function() { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, ta(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, ta(a, a._zoomButton, "pan"));
                        a.render() }, this.allDOMEventHandlers);
                    V(this._zoomButton, "mouseover", function() {
                        d ? d = !1 : (na(a, a._zoomButton, { backgroundColor: a.toolbar.backgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && na(a, a._zoomButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }))
                    }, this.allDOMEventHandlers);
                    V(this._zoomButton, "mouseout", function() { d || (na(a, a._zoomButton, { backgroundColor: a.toolbar.backgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && na(a, a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) }, this.allDOMEventHandlers)
                }
                this._resetButton || (d = !1, sa(this._resetButton = document.createElement("button")), ta(this, this._resetButton,
                    ...
                    a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, ta(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor =
                ...
                this.zoomEnabled || this.panEnabled || (this._zoomButton ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? (this.panEnabled = !0, this.zoomEnabled = !1) : (this.zoomEnabled = !0, this.panEnabled = !1), Ia(a._zoomButton, a._resetButton)) : (this.zoomEnabled = !0, this.panEnabled = !1))
            } else this.panEnabled = this.zoomEnabled = !1;
            eb(this);
            "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? ta(a,
                a._zoomButton, "zoom") : ta(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && ta(a, a._resetButton, "reset"));
        ...
        m.prototype._updateSize = function() {
            ...
            if (this.canvas.width !== d * ga || this.canvas.height !== c * ga) { for (var b = 0; b < a.length; b++) Ja(a[b], d, c);
        ...
        m.prototype._initialize = function() {
            ...
            this.layoutManager = new Ba(0, 0, this.width, this.height, this.isNavigator ? 0 : 2);
        ...
        m.prototype.setLayout = function() {
            ...
            c ? (Ia(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.borderThickness +
                "px solid " + this.toolbar.borderColor, this._zoomButton.style.borderRight = this.toolbar.borderThickness + "px solid " + this.toolbar.borderColor, this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor) : (sa(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.borderThickness + "px solid transparent", this.options.zoomEnabled && (this.zoomEnabled = !0, this.panEnabled = !1));
            cb(this);
            this._processData();
            this.options.title && (this.title =
                new wa(this, this.options.title), this.title.dockInsidePlotArea ? a.push(this.title) : this.title.setLayout());
            this.subtitles = [];
            if (this.options.subtitles)
                for (d = 0; d < this.options.subtitles.length; d++) c = new Fa(this, this.options.subtitles[d], d), this.subtitles.push(c), c.dockInsidePlotArea ? a.push(c) : c.setLayout();
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) { u ? (this._breaksCanvas = ra(this.width, this.height, !0), this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")) : (this._breaksCanvas = this.canvas, this._breaksCanvasCtx = this.ctx); break }
        ...
        m.prototype.renderElements = function() {
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var f = this.plotInfo.plotTypes[d], p = 0; p < f.plotUnits.length; p++) {
                    ...
                    l.targetCanvas =
                        null;
                    this.animatedRender && (l.targetCanvas = ra(this.width, this.height), l.targetCanvasCtx = l.targetCanvas.getContext("2d"), e = l.targetCanvasCtx.miterLimit, l.targetCanvasCtx.miterLimit = 3);
                    "line" === l.type ? B = this.renderLine(l) : "stepLine" === l.type ? B = this.renderStepLine(l) : "spline" === l.type ? B = this.renderSpline(l) : "column" === l.type ? B = this.renderColumn(l) : "bar" === l.type ? B = this.renderBar(l) : "area" === l.type ? B = this.renderArea(l) : "stepArea" === l.type ? B = this.renderStepArea(l) : "splineArea" === l.type ? B = this.renderSplineArea(l) :
                    ...
                    this.animatedRender && (l.targetCanvasCtx.miterLimit = e, B && c.push(B))
                }
            ...
            this.zoomEnabled || (this.panEnabled || !this._zoomButton || "none" === this._zoomButton.style.display) || sa(this._zoomButton, this._resetButton);
            this.toolTip._updateToolTip();
            this.renderCount++;
            Ea && (n = this, setTimeout(function() { var a = document.getElementById("ghostCanvasCopy");
                a && (Ja(a, n.width, n.height), a.getContext("2d").drawImage(n._eventManager.ghostCanvas, 0, 0)) }, 2E3));
        ...
        m.prototype._processMultiseriesPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (l.dataPoints[B].x && l.dataPoints[B].x.getTime || "dateTime" === l.xValueType) f = !0;
                    for (B = 0; B < l.dataPoints.length; B++) {
                        "undefined" === typeof l.dataPoints[B].x && (l.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0));
                        l.dataPoints[B].x.getTime ? (f = !0, b = l.dataPoints[B].x.getTime()) : b = l.dataPoints[B].x;
                        e = l.dataPoints[B].y;
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        ...
                        if (0 < B) {
                            if (a.axisX.logarithmic) {
                                var v =
                                    b / l.dataPoints[B - 1].x;
                                1 > v && (v = 1 / v);
                                c.minDiff > v && 1 !== v && (c.minDiff = v)
                            } else v = b - l.dataPoints[B - 1].x, 0 > v && (v *= -1), c.minDiff > v && 0 !== v && (c.minDiff = v);
                            null !== e && null !== l.dataPoints[B - 1].y && (a.axisY.logarithmic ? (v = e / l.dataPoints[B - 1].y, 1 > v && (v = 1 / v), d.minDiff > v && 1 !== v && (d.minDiff = v)) : (v = e - l.dataPoints[B - 1].y, 0 > v && (v *= -1), d.minDiff > v && 0 !== v && (d.minDiff = v)))
                        }
                        if (b < q && !h) null !== e && (r = b);
                        else {
                            if (!h && (h = !0, 0 < B)) { B -= 2; continue }
                            if (b > g && !n) n = !0;
                            else if (b > g && n) continue;
                            l.dataPoints[B].label && (a.axisX.labels[b] = l.dataPoints[B].label);
                ...
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = [], l = [], B = Infinity, h = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    for (q = 0; q < r.dataPoints.length; q++) {
                        ...
                        if (b < m && !g) null !== r.dataPoints[q].y && (k = b);
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === r.dataPoints[q].y ? c.viewPortMin === b && k < b && (c.viewPortMin = k) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, 0 <= e ? p[b] ? p[b] += e : (p[b] = e, B = Math.min(e, B)) : l[b] ? l[b] += e : (l[b] = e, h = Math.max(e, h)))
                        }
                    }
        ...
        m.prototype._processMultiYPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, p, l = !1, B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    for (n = 0; n < h.dataPoints.length; n++) {
                        ...
                        f < d.min && (d.min = f);
                        p > d.max && (d.max = p);
                        0 < n && (a.axisX.logarithmic ? (v = b / h.dataPoints[n - 1].x, 1 > v && (v = 1 / v), c.minDiff > v && 1 !== v && (c.minDiff = v)) : (v = b - h.dataPoints[n - 1].x, 0 > v && (v *= -1), c.minDiff > v && 0 !== v && (c.minDiff = v)), e && (null !== e[0] && h.dataPoints[n - 1].y && null !== h.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (v = e[0] / h.dataPoints[n - 1].y[0], 1 > v && (v = 1 / v), d.minDiff > v && 1 !== v && (d.minDiff = v)) : (v = e[0] - h.dataPoints[n - 1].y[0], 0 > v && (v *= -1), d.minDiff > v && 0 !== v && (d.minDiff = v))));
            ...
            function(a) {
                if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                    for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                        ...
                        if (l.dataPoints[B].x && l.dataPoints[B].x.getTime || "dateTime" === l.xValueType) f = !0;
                        for (B = 0; B < l.dataPoints.length; B++) "undefined" !== typeof l.dataPoints[B].isCumulativeSum &&
                            !0 === l.dataPoints[B].isCumulativeSum ? (l.dataPointEOs[B].cumulativeSumYStartValue = 0, l.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum, l.dataPoints[B].y = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum) : "undefined" !== typeof l.dataPoints[B].isIntermediateSum && !0 === l.dataPoints[B].isIntermediateSum ? (l.dataPointEOs[B].cumulativeSumYStartValue = r, l.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum, l.dataPoints[B].y = 0 === B ? 0 : b, r = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum,
                                b = 0) : (e = "number" !== typeof l.dataPoints[B].y ? 0 : l.dataPoints[B].y, l.dataPointEOs[B].cumulativeSumYStartValue = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum, l.dataPointEOs[B].cumulativeSum = 0 === B ? e : l.dataPointEOs[B - 1].cumulativeSum + e, b += e);
                        for (B = 0; B < l.dataPoints.length; B++)
                            if ("undefined" === typeof l.dataPoints[B].x && (l.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)), l.dataPoints[B].x.getTime ? (f = !0, b = l.dataPoints[B].x.getTime()) : b = l.dataPoints[B].x, e = l.dataPoints[B].y, b < c.min && (c.min = b), b > c.max && (c.max = b), l.dataPointEOs[B].cumulativeSum <
                                ...
                                b < c.viewPortMin && (c.viewPortMin = b);
                                b > c.viewPortMax && (c.viewPortMax = b);
                                0 < B && (l.dataPointEOs[B - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = l.dataPointEOs[B - 1].cumulativeSum), l.dataPointEOs[B - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = l.dataPointEOs[B - 1].cumulativeSum));
                                l.dataPointEOs[B].cumulativeSum < d.viewPortMin && (d.viewPortMin = l.dataPointEOs[B].cumulativeSum);
                                l.dataPointEOs[B].cumulativeSum > d.viewPortMax && (d.viewPortMax = l.dataPointEOs[B].cumulativeSum)
                            }
                        l.axisX.valueType = l.xValueType = f ? "dateTime" : "number"
                    }
            };
        m.prototype.calculateAutoBreaks = function() {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c)
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, p = f.max, l = d.min, n = d.max, f = f._dataRanges, d = d._dataRanges, q, r = 0, B = 0; B < a.dataSeriesIndexes.length; B++) {
                ...
                for (p = 0; p < this._axes.length; p++)
                    if (this._axes[p].dataInfo._dataRanges) {
                        ...
                        if (this._axes[p].dataInfo.dataPointYPositiveSums) {
                            ...
                            n = h;
                            for (l in q)
                                if (q.hasOwnProperty(l) && !isNaN(l) && (r = q[l], !s(r))) { var g = Math.floor((r - B) / b);
                                    r < n[g].min && (n[g].min = r);
                                    r > n[g].max && (n[g].max = r) }
                        ...
                        if (this._axes[p].dataInfo.dataPointYNegativeSums) { q = this._axes[p].dataInfo.dataPointYNegativeSums;
                            n = h; for (l in q) q.hasOwnProperty(l) && !isNaN(l) && (r = -1 * q[l], s(r) || (g = Math.floor((r - B) / b), r < n[g].min && (n[g].min = r), r > n[g].max && (n[g].max = r)));
                            delete this._axes[p].dataInfo.dataPointYNegativeSums }
                        for (l = 0; l < h.length -
                            1; l++)
                            if (n = h[l].max, isFinite(n))
                                for (; l < h.length - 1;)
                                    if (B = h[l + 1].min, isFinite(B)) { r = B - n;
                                        r > b && f.push({ diff: r, start: n, end: B }); break } else l++;
        ...
        m.prototype._mouseEventHandler = function(a) {
            ...
            if (this.interactivityEnabled)
                ...
                else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ea && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === c && window.console.log("mouseup")), !e) {
        ...
        m.prototype._plotAreaMouseUp = function(a, d) {
            ...
            if ("none" !== this.plotInfo.axisPlacement) {
                ...
                if (this.axisY && 0 < this.axisY.length)
                    for (p = 0; p < this.axisY.length; p++) this.axisY[p].crosshair && this.axisY[p].crosshair.enabled &&
        ...
        m.prototype._plotAreaMouseMove = function(a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                    if (this.panEnabled) e = { x1: e ? this.plotArea.x1 + c : this.plotArea.x1, y1: f ? this.plotArea.y1 + b : this.plotArea.y1, x2: e ? this.plotArea.x2 + c : this.plotArea.x2, y2: f ? this.plotArea.y2 + b : this.plotArea.y2 },
        ...
        m.prototype.validateRegion = function(a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), p = 0 <= this.zoomType.indexOf("y"), l = !1, B = [], h = [], n = [], r = 0; r < this._axes.length; r++)("axisX" === this._axes[r].type && f || "axisY" === this._axes[r].type && p) && h.push(this._axes[r]);
            for (p = 0; p < h.length; p++) {
                ...
                if (q > g) var v = g,
                    ...
                    q = v;
                if (r.scaleBreaks)
                    for (v = 0; !f && v < r.scaleBreaks._appliedBreaks.length; v++) f =
                        r.scaleBreaks._appliedBreaks[v].startValue <= q && r.scaleBreaks._appliedBreaks[v].endValue >= g;
                if (isFinite(r.dataInfo.minDiff))
                    if (v = r.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && r.scaleBreaks && r.scaleBreaks._appliedBreaks.length) && (r.logarithmic && v < Math.pow(r.dataInfo.minDiff, 3) || !r.logarithmic && v < 3 * Math.abs(r.dataInfo.minDiff)) || q < r.minimum || g > r.maximum)) B.push(r), n.push({ val1: q, val2: g }), l = !0;
                    else if (!e) { l = !1; break }
            }
        ...
        m.prototype.preparePlotArea =
            function() {
                ...
                u || (a.canvas.width = a.width, a.canvas.height = a.height, a.canvas.style.left =
        ...
        m.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var h = this._indexLabels[a],
                    ...
                    r, q, l = ka("indexLabelFontColor", h.dataPoint, h.dataSeries),
                ...
                var p = ka("indexLabelFontWeight", h.dataPoint, h.dataSeries),
                    ...
                    m = s(h.dataPoint.indexLabelLineThickness) ? s(h.dataSeries.options.indexLabelLineThickness) ? 0 : h.dataSeries.options.indexLabelLineThickness :
                ...
                if (null !== F && "" !== F) {
                    var t = ka("indexLabelPlacement", h.dataPoint, h.dataSeries),
                        x = ka("indexLabelOrientation", h.dataPoint,
                            h.dataSeries),
                        C = h.direction,
                        A = h.dataSeries.axisX,
                        z = h.dataSeries.axisY,
                        w = !1,
                        g = new ia(d, { x: 0, y: 0, maxWidth: e ? e : 0.5 * this.width, maxHeight: f ? 5 * B : 1.5 * B, angle: "horizontal" === x ? 0 : -90, text: F, padding: 0, backgroundColor: g, horizontalAlign: "left", fontSize: B, fontFamily: r, fontWeight: p, fontColor: l, fontStyle: q, textBaseline: "top" });
                    g.measureText();
                    h.dataSeries.indexLabelMaxWidth = g.maxWidth;
                    if ("stackedarea100" === n) { if (h.point.x < c.x1 || h.point.x > c.x2 || h.point.y < c.y1 - 1 || h.point.y > c.y2 + 1) continue } else if ("rangearea" === n ||
                        ...
                        A.viewportMinimum || h.dataPoint.x > A.viewportMaximum) continue;
                    e = p = 2;
                    "horizontal" === x ? (l = g.width, B = g.height) : (B = g.width, l = g.height);
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        r = h.point.x - l / 2;
                        "inside" !== t ? (e = c.y1, f = c.y2, 0 < C ? (q = h.point.y - B - p - b, q < e && (q = "auto" === t ? Math.max(h.point.y, e) + p + b : e + p + b, w = q + B > h.point.y)) : (q = h.point.y + p + b, q > f - B - p - b && (q =
                        ...
                        c.x1) + l / 2 + e : Math.min(h.bounds.x2, c.x2) - l / 2 - e : (Math.max(h.bounds.x1, c.x1) + Math.min(h.bounds.x2, c.x2)) / 2, r = 0 > C ? Math.max(h.point.x, b) - l / 2 : Math.min(h.point.x, b) - l / 2, r = Math.max(r, p));
                    "vertical" === x && (q += B);
                    g.x = r;
                    g.y = q;
                    g.render(!0);
                    m && ("inside" !== t && (0 > n.indexOf("bar") && ("error" !== n || !h.axisSwapped) && h.point.x > c.x1 && h.point.x < c.x2 || !w) && (0 > n.indexOf("column") && ("error" !== n || h.axisSwapped) && h.point.y > c.y1 && h.point.y < c.y2 || !w)) && (d.lineWidth = m, d.strokeStyle = k ? k : "gray", d.setLineDash && d.setLineDash(N(v, m)),
            ...
            for (a = 0; a <
                this._indexLabels.length; a++) h = this._indexLabels[a], g = ka("indexLabelBackgroundColor", h.dataPoint, h.dataSeries), h.dataSeries.indexLabelBackgroundColor = s(g) ? u ? "transparent" : null : g;
            return d
        };
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (c.setLineDash) { var q = N(h.nullDataLineDashType, h.lineThickness),
                        ...
                        c.setLineDash(g) }
                    var v = h.id;
                    this._eventManager.objectMap[v] = { objectType: "dataSeries", dataSeriesIndex: B };
                    v = P(v);
                    b.strokeStyle = v;
                    ...
                    if (0 < n.length) {
                        for (var C = !1, t = 0; t < n.length; t++)
                            if (x = n[t].x.getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C)))
                                if ("number" !== typeof n[t].y) 0 < t && !(h.connectNullData || C || m) && (c.stroke(), u && b.stroke()), C = !0;
                                else {
                                    x = a.axisX.convertValueToPixel(x);
                                    s = a.axisY.convertValueToPixel(n[t].y);
                                    var A = h.dataPointIds[t];
                                    this._eventManager.objectMap[A] = { id: A, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: t, x1: x, y1: s };
                                    m || C ? (!m && h.connectNullData ?
                                        (c.setLineDash && (h.options.nullDataLineDashType || r === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(p.x, p.y), r = h.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, s), u && b.lineTo(x, s)) : (c.beginPath(), c.moveTo(x, s), u && (b.beginPath(), b.moveTo(x, s))), C = m = !1) : (c.lineTo(x, s), u && b.lineTo(x, s), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), u && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                                    p = { x: x, y: s };
                                    t < n.length - 1 && (k !== (n[t].lineColor || v) || r !== (n[t].lineDashType ||
                                        h.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, s), k = n[t].lineColor || v, c.strokeStyle = k, c.setLineDash && (n[t].lineDashType ? (r = n[t].lineDashType, c.setLineDash(N(r, h.lineThickness))) : (r = h.lineDashType, c.setLineDash(g))));
                                    if (0 < n[t].markerSize || 0 < h.markerSize) { var z = h.getMarkerProperties(t, x, s, c);
                                        f.push(z);
                                        A = P(A);
                                        u && f.push({ x: x, y: s, ctx: b, type: z.type, size: z.size, color: A, borderColor: A, borderThickness: z.borderThickness }) }(n[t].indexLabel || h.indexLabel || n[t].indexLabelFormatter || h.indexLabelFormatter) &&
        ...
        m.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    b.lineWidth = 0 < h.lineThickness ? Math.max(h.lineThickness, 4) : 0;
                    var v = h._colorSet,
                        k = v = h.lineColor = h.options.lineColor ? h.options.lineColor :
                        v[0];
                    c.strokeStyle = v;
                    var m = !0,
                        t = 0,
                    ...
                    if (0 < n.length) {
                        for (var C = !1, t = 0; t < n.length; t++)
                            if (x = n[t].getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C)))
                                if ("number" !== typeof n[t].y) 0 < t && !(h.connectNullData || C || m) && (c.stroke(), u && b.stroke()), C = !0;
                                else {
                                    var A = s;
                                    x = a.axisX.convertValueToPixel(x);
                                    ...
                                    p = { x: x, y: s };
                                    t < n.length - 1 && (k !== (n[t].lineColor || v) || r !== (n[t].lineDashType || h.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, s), k = n[t].lineColor || v, c.strokeStyle = k, c.setLineDash && (n[t].lineDashType ? (r = n[t].lineDashType, c.setLineDash(N(r, h.lineThickness))) : (r = h.lineDashType, c.setLineDash(g))));
                                    if (0 < n[t].markerSize || 0 < h.markerSize) A = h.getMarkerProperties(t, x, s, c), f.push(A), z = P(z), u && f.push({
                                        x: x,
                                        y: s,
                                        ctx: b,
                                        type: A.type,
            ...
            function d(a) {
                ...
                if (0 < a.length) {
                    ...
                    for (var c = 0; c < a.length - 3; c += 3)
                        if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), u && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), 0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray &&
                            b.setLineDash(a[c + 3].newLineDashArray), u && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y));
                    b.stroke();
                    u && e.stroke()
                }
            }
                        ...
                        for (x = !1, m = 0; m < n.length; m++)
                            if (t = n[m].getTime ? n[m].x.getTime() : n[m].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x)))
                                if ("number" !== typeof n[m].y) 0 < m && !x && (h.connectNullData ? b.setLineDash && (0 < s.length && (h.options.nullDataLineDashType || !n[m - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = q, r = h.nullDataLineDashType) : (d(s), s = [])), x = !0;
                                    ...
                                    s[s.length] = { x: t, y: x };
                                    m < n.length - 1 && (k !== (n[m].lineColor || v) || r !== (n[m].lineDashType || h.lineDashType)) && (k = n[m].lineColor || v, s[s.length - 1].newStrokeStyle = k, b.setLineDash && (n[m].lineDashType ? (r = n[m].lineDashType, s[s.length - 1].newLineDashArray = N(r, h.lineThickness)) : (r = h.lineDashType, s[s.length - 1].newLineDashArray = g)));
                                    if (0 < n[m].markerSize || 0 < h.markerSize) { var A = h.getMarkerProperties(m, t, x, b);
                                        p.push(A);
                                        C = P(C);
                                        u && p.push({ x: t, y: x, ctx: e, type: A.type, size: A.size, color: C, borderColor: C, borderThickness: A.borderThickness }) }(n[m].indexLabel ||
                                        h.indexLabel || n[m].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: n[m], dataSeries: h, point: { x: t, y: x }, direction: 0 > n[m].y === a.axisY.reversed ? 1 : -1, color: v });
                                    x = !1
                                }
                    d(s)
                }
        ...
        m.prototype.renderColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    p, l, B, h = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                ...
                r = this.dataPointWidth = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(r) /
                    Math.log(a.axisX.range) : Math.abs(r) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q = a.dataSeriesIndexes[n],
                        ...
                        v = g.dataPoints;
                    if (0 < v.length)
                        for (var k = 5 < r && g.bevelEnabled ? !0 : !1, f = 0; f < v.length; f++)
                            if (v[f].getTime ? B = v[f].x.getTime() : B = v[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof v[f].y) {
                                p = a.axisX.convertValueToPixel(B);
                                l = a.axisY.convertValueToPixel(v[f].y);
                                p = a.axisX.reversed ? p + a.plotType.totalDataSeries * r / 2 - (a.previousDataSeriesCount +
                                    n) * r << 0 : p - a.plotType.totalDataSeries * r / 2 + (a.previousDataSeriesCount + n) * r << 0;
                                var m = a.axisX.reversed ? p - r << 0 : p + r << 0,
                                    t;
                                0 <= v[f].y ? t = h : (t = l, l = h);
                                l > t && (b = l, l = t, t = b);
                                b = v[f].color ? v[f].color : g._colorSet[f % g._colorSet.length];
                                ca(c, p, l, m, t, b, 0, null, k && 0 <= v[f].y, 0 > v[f].y && k, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                        ...
                        for (h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                ...
                                var s = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    C = s + g << 0,
                                    A;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) l[b] = t[h].y + (l[b] ? l[b] : 0), 0 < l[b] && (r = a.axisY.convertValueToPixel(l[b]), A = "undefined" !== typeof f[b] ? f[b] : q, f[b] = r);
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) B[b] = t[h].y + (B[b] ? B[b] : 0), A = a.axisY.convertValueToPixel(B[b]), r = "undefined" !== typeof p[b] ?
                                    p[b] : q, p[b] = A;
                                else if (r = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) { var z = "undefined" !== typeof f[b] ? f[b] : 0;
                                    r -= z;
                                    A = q - z;
                                    f[b] = z + (A - r) } else z = p[b] ? p[b] : 0, A = r + z, r = q + z, p[b] = z + (A - r);
                                b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length];
                                ca(c, s, r, C, A, b, 0, null, x && 0 <= t[h].y, 0 > t[h].y && x, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: s, y1: r, x2: C, y2: A };
                                b = P(b);
                                u && ca(this._eventManager.ghostCtx, s, r, C, A, b, 0, null, !1, !1, !1, !1);
                                (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn", dataPoint: t[h], dataSeries: m, point: { x: n, y: 0 <= t[h].y ? r : A }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: s, y1: Math.min(r, A), x2: C, y2: Math.max(r, A) }, color: b })
                            }
                    }
                }
                u && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas &&
                        ...
                        for (var x = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                var s = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    C = s + g << 0,
                                    A;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) { l[b] = r + ("undefined" !== typeof l[b] ? l[b] : 0); if (0 >= l[b]) continue;
                                    r = a.axisY.convertValueToPixel(l[b]);
                                    A = f[b] ? f[b] : q;
                                    f[b] = r } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) B[b] = r + ("undefined" !== typeof B[b] ? B[b] : 0),
                                    A = a.axisY.convertValueToPixel(B[b]), r = p[b] ? p[b] : q, p[b] = A;
                                else if (r = a.axisY.convertValueToPixel(r), 0 <= t[h].y) { var z = "undefined" !== typeof f[b] ? f[b] : 0;
                                    r -= z;
                                    A = q - z;
                                    a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.y1 - r) && (r = e.y1);
                                    f[b] = z + (A - r) } else z = "undefined" !== typeof p[b] ? p[b] : 0, A = r + z, r = q + z, a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.y2 - A) && (A = e.y2), p[b] = z + (A - r);
                                b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length];
                                ca(c, s, r, C, A, b, 0, null, x && 0 <= t[h].y, 0 > t[h].y && x, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: s, y1: r, x2: C, y2: A };
                                b = P(b);
                                u && ca(this._eventManager.ghostCtx, s, r, C, A, b, 0, null, !1, !1, !1, !1);
                                (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn100", dataPoint: t[h], dataSeries: m, point: { x: n, y: 0 <= t[h].y ? r : A }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: s, y1: Math.min(r, A), x2: C, y2: Math.max(r, A) }, color: b })
                            }
                }
                u && (d.drawImage(this._preRenderCanvas,
        ...
        m.prototype.renderBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    p, l, B, h = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                    n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth :
                        ...
                        for (f = 0; f < v.length; f++)
                            if (v[f].getTime ? B = v[f].x.getTime() : B = v[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof v[f].y) {
                                ...
                                (v[f].indexLabel || g.indexLabel || v[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    ...
                                    direction: 0 > v[f].y === a.axisY.reversed ?
                                        1 : -1,
                                    bounds: { x1: Math.min(t, p), y1: l, x2: Math.max(t, p), y2: m },
                                    color: b
                                })
                            }
                    }
        ...
        m.prototype.renderStackedBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                this.dataPointMaxWidth && h > r && (h = Math.min(this.options.dataPointWidth ?
                        ...
                        for (h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                var s = r - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    C = s + g << 0,
                                    A;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) l[b] = t[h].y + (l[b] ? l[b] : 0), 0 < l[b] && (A = f[b] ? f[b] :
                                    q, f[b] = n = a.axisY.convertValueToPixel(l[b]));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) B[b] = t[h].y + (B[b] ? B[b] : 0), n = p[b] ? p[b] : q, p[b] = A = a.axisY.convertValueToPixel(B[b]);
                                else if (n = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) { var z = f[b] ? f[b] : 0;
                                    A = q + z;
                                    n += z;
                                    f[b] = z + (n - A) } else z = p[b] ? p[b] : 0, A = n - z, n = q - z, p[b] = z + (n - A);
                                b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length];
                                ca(c, A, s, n, C, b, 0, null, x, !1, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: A, y1: s, x2: n, y2: C };
                                b = P(b);
                                u && ca(this._eventManager.ghostCtx, A, s, n, C, b, 0, null, !1, !1, !1, !1);
                                (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: t[h], dataSeries: m, point: { x: 0 <= t[h].y ? n : A, y: r }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(A, n), y1: s, x2: Math.max(A, n), y2: C }, color: b })
                            }
                    }
                }
        ...
        m.prototype.renderStackedBar100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                !this.dataPointMaxWidth && (this.dataPointMinWidth &&
                    r < h) && (r = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h));
                g < h && (g = h);
                g > r && (g = r);
                c.save();
                u && this._eventManager.ghostCtx.save();
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                r = a.axisX.convertValueToPixel(b);
                                var s;
                                s = 0 !== a.dataPointYSums[b] ? 100 * (t[h].y / a.dataPointYSums[b]) : 0;
                                var C = r - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    A = C + g << 0;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) { l[b] = s + (l[b] ? l[b] : 0); if (0 >= l[b]) continue;
                                    s = f[b] ? f[b] : q;
                                    f[b] = n = a.axisY.convertValueToPixel(l[b]) } else if (a.axisY.scaleBreaks &&
                                    0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) B[b] = s + (B[b] ? B[b] : 0), n = p[b] ? p[b] : q, p[b] = s = a.axisY.convertValueToPixel(B[b]);
                                else if (n = a.axisY.convertValueToPixel(s), 0 <= t[h].y) { var z = f[b] ? f[b] : 0;
                                    s = q + z;
                                    n += z;
                                    a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.x2 - n) && (n = e.x2);
                                    f[b] = z + (n - s) } else z = p[b] ? p[b] : 0, s = n - z, n = q - z, a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.x1 - s) && (s = e.x1), p[b] = z + (n - s);
                                b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length];
                                ca(c, s, C, n, A, b, 0, null, x, !1, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: s, y1: C, x2: n, y2: A };
                                b = P(b);
                                u && ca(this._eventManager.ghostCtx, s, C, n, A, b, 0, null, !1, !1, !1, !1);
                                (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: t[h], dataSeries: m, point: { x: 0 <= t[h].y ? n : s, y: r }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(s, n), y1: C, x2: Math.max(s, n), y2: A }, color: b })
                            }
                    }
                }
                u &&
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < v.length) {
                        ...
                        for (var ja = !0; k < v.length; k++)
                            if (s = v[k].x.getTime ? v[k].x.getTime() : v[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja)))
                                if ("number" !== typeof v[k].y) g.connectNullData || (ja || d) || b(), ja = !0;
                                else {
                                    m = a.axisX.convertValueToPixel(s);
                                    t = a.axisY.convertValueToPixel(v[k].y);
                                    d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(), f.moveTo(n.x,
                                        n.y), m = d, t = c, A = n, c = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(m, t), u && p.lineTo(m, t)) : (f.beginPath(), f.moveTo(m, t), u && (p.beginPath(), p.moveTo(m, t)), A = { x: m, y: t }), ja = d = !1) : (f.lineTo(m, t), u && p.lineTo(m, t), 0 == k % 250 && b());
                                    n = { x: m, y: t };
                                    k < v.length - 1 && (y !== (v[k].lineColor || w) || c !== (v[k].lineDashType || g.lineDashType)) && (b(), y = v[k].lineColor || w, f.strokeStyle = y, f.setLineDash && (v[k].lineDashType ? (c = v[k].lineDashType, f.setLineDash(N(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(R))));
                                    ...
                                    0 !== v[k].markerSize && (0 < v[k].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(k, m, t, f), B.push(s), Z = P(Z), u && B.push({ x: m, y: t, ctx: p, type: s.type, size: s.size, color: Z, borderColor: Z, borderThickness: s.borderThickness }));
        ...
        m.prototype.renderSplineArea = function(a) {
                ...
                if (0 < c.length) {
                    if (0 < n.lineThickness) {
                        ...
                        for (var d = 0; d < c.length - 3; d += 3)
                            if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), u &&
                    ...
                    for (d = 0; d < c.length - 3; d += 3) b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), u && e.bezierCurveTo(c[d +
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    var p = [],
                        q = 0,
                        g, v, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum :
                            0),
                        m, t = null,
                        s = [];
                    if (0 < r.length) {
                        ...
                        for (v = !1; q < r.length; q++)
                            if (g = r[q].x.getTime ? r[q].x.getTime() : r[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !v)))
                                if ("number" !== typeof r[q].y) 0 < q &&
                                    !v && (n.connectNullData ? b.setLineDash && (0 < s.length && (n.options.nullDataLineDashType || !r[q - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = y, z = n.nullDataLineDashType) : (d(), s = [])), v = !0;
                                else {
                                    ...
                                    s[s.length] = { x: g, y: v };
                                    q < r.length - 1 && (A !== (r[q].lineColor || C) || z !== (r[q].lineDashType || n.lineDashType)) && (A = r[q].lineColor ||
                                        C, s[s.length - 1].newStrokeStyle = A, b.setLineDash && (r[q].lineDashType ? (z = r[q].lineDashType, s[s.length - 1].newLineDashArray = N(z, n.lineThickness)) : (z = n.lineDashType, s[s.length - 1].newLineDashArray = D)));
                                    if (0 !== r[q].markerSize && (0 < r[q].markerSize || 0 < n.markerSize)) { var R = n.getMarkerProperties(q, g, v, b);
                                        p.push(R);
                                        S = P(S);
                                        u && p.push({ x: g, y: v, ctx: e, type: R.type, size: R.size, color: S, borderColor: S, borderThickness: R.borderThickness }) }(r[q].indexLabel || n.indexLabel || r[q].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < v.length) {
                        ...
                        for (; k < v.length; k++)
                            if (s = v[k].x.getTime ? v[k].x.getTime() : v[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                var Z = t;
                                "number" !== typeof v[k].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(s), t = a.axisY.convertValueToPixel(v[k].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || S === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m,
        ...
        m.prototype.renderStackedArea = function(a) {
            function d() {
                if (!(1 > h.length)) {
                    for (0 < z.lineThickness && b.stroke(); 0 < h.length;) { var a = h.pop();
                        b.lineTo(a.x, a.y);
                        u && s.lineTo(a.x, a.y) }
                    b.closePath();
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    r = [],
                    q = 0,
                    g, v, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var A =
                        ...
                        w = z.dataPoints;
                    z.dataPointIndexes = [];
                    for (q = 0; q < w.length; q++) A = w[q].x.getTime ? w[q].x.getTime() : w[q].x, z.dataPointIndexes[A] = q, e[A] || (n.push(A), e[A] = !0);
                    n.sort(Na)
                }
                for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if (0 < n.length) {
                        ...
                        F = "solid";
                        if (b.setLineDash) { var R = N(z.nullDataLineDashType, z.lineThickness);
                            F = z.lineDashType; var D = N(F, z.lineThickness);
                            b.setLineDash(D) }
                        for (var Z = !0, q = 0; q < n.length; q++) {
                            var f = n[q],
                                fa = null,
                                fa = 0 <= z.dataPointIndexes[f] ? w[z.dataPointIndexes[f]] : { x: f, y: null };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Z)))
                                if ("number" !== typeof fa.y) z.connectNullData || (Z || x) || d(), Z = !0;
                                else {
                                    g = a.axisX.convertValueToPixel(f);
                                    var la =
                                        k[f] ? k[f] : 0;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { r[f] = fa.y + (r[f] ? r[f] : 0); if (0 >= r[f] && a.axisY.logarithmic) continue;
                                        v = a.axisY.convertValueToPixel(r[f]) } else v = a.axisY.convertValueToPixel(fa.y), v -= la;
                                    h.push({ x: g, y: m - la });
                                    k[f] = m - v;
                                    x || Z ? (!x && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || F === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (x = h.pop(), F = h[h.length - 1], d(), b.moveTo(t.x, t.y), h.push(F), h.push(x), F = z.nullDataLineDashType,
                                        b.setLineDash(R)), b.lineTo(g, v), u && s.lineTo(g, v)) : (b.beginPath(), b.moveTo(g, v), u && (s.beginPath(), s.moveTo(g, v))), Z = x = !1) : (b.lineTo(g, v), u && s.lineTo(g, v), 0 == q % 250 && (d(), b.moveTo(g, v), u && s.moveTo(g, v), h.push({ x: g, y: m - la })));
                                    t = { x: g, y: v };
                                    q < w.length - 1 && (S !== (w[q].lineColor || y) || F !== (w[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, v), h.push({ x: g, y: m - la }), S = w[q].lineColor || y, b.strokeStyle = S, b.setLineDash && (w[q].lineDashType ? (F = w[q].lineDashType, b.setLineDash(N(F, z.lineThickness))) : (F =
                                        z.lineDashType, b.setLineDash(D))));
                                    if (0 <= z.dataPointIndexes[f]) { var E = z.dataPointIds[z.dataPointIndexes[f]];
                                        this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: A, dataPointIndex: z.dataPointIndexes[f], x1: g, y1: v } }
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (la = z.getMarkerProperties(z.dataPointIndexes[f], g, v, b), p.push(la), f = P(E), u && p.push({ x: g, y: v, ctx: s, type: la.type, size: la.size, color: f, borderColor: f, borderThickness: la.borderThickness }));
                                    (fa.indexLabel ||
                ...
                u && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas,
                    0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), s.restore());
                b.restore();
                return { source: c, dest: this.plotArea.ctx, animationCallback: L.xClipAnimation, easingFunction: L.easing.linear, animationBase: 0 }
            }
        };
        m.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    r = [],
                    q = 0,
                    g, v, m, s, t, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                b.clip();
                u && (F.beginPath(), F.rect(p.x1, p.y1, p.width,
                    p.height), F.clip());
                for (var e = [], w = 0; w < a.dataSeriesIndexes.length; w++) { var A = a.dataSeriesIndexes[w],
                        z = this.data[A],
                        y = z.dataPoints;
                    z.dataPointIndexes = []; for (q = 0; q < y.length; q++) A = y[q].x.getTime ? y[q].x.getTime() : y[q].x, z.dataPointIndexes[A] = q, e[A] || (n.push(A), e[A] = !0);
                    n.sort(Na) }
                for (w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    if (0 < n.length) {
                        ...
                        t = "solid";
                        if (b.setLineDash) { var R = N(z.nullDataLineDashType, z.lineThickness);
                            t = z.lineDashType; var E = N(t, z.lineThickness);
                            b.setLineDash(E) }
                        for (var Z = !0, q = 0; q < n.length; q++) {
                            var f = n[q],
                                fa = null,
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Z)))
                                if ("number" !== typeof fa.y) z.connectNullData ||
                                    ...
                                    g = a.axisX.convertValueToPixel(f);
                                    var ba = k[f] ? k[f] : 0;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { r[f] = la + (r[f] ? r[f] : 0); if (0 >= r[f] && a.axisY.logarithmic) continue;
                                        v = a.axisY.convertValueToPixel(r[f]) } else v = a.axisY.convertValueToPixel(la), v -= ba;
                                    h.push({ x: g, y: x - ba });
                                    k[f] = x - v;
                                    s || Z ? (!s && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || t === z.lineDashType &&
                                        z.lineDashType !== z.nullDataLineDashType) && (s = h.pop(), t = h[h.length - 1], d(), b.moveTo(m.x, m.y), h.push(t), h.push(s), t = z.nullDataLineDashType, b.setLineDash(R)), b.lineTo(g, v), u && F.lineTo(g, v)) : (b.beginPath(), b.moveTo(g, v), u && (F.beginPath(), F.moveTo(g, v))), Z = s = !1) : (b.lineTo(g, v), u && F.lineTo(g, v), 0 == q % 250 && (d(), b.moveTo(g, v), u && F.moveTo(g, v), h.push({ x: g, y: x - ba })));
                                    m = { x: g, y: v };
                                    q < y.length - 1 && (S !== (y[q].lineColor || D) || t !== (y[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, v), h.push({
                                        x: g,
                                        y: x -
                                            ba
                                    ...
                                    if (0 <= z.dataPointIndexes[f]) { var G = z.dataPointIds[z.dataPointIndexes[f]];
                                        this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: A, dataPointIndex: z.dataPointIndexes[f], x1: g, y1: v } }
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ba = z.getMarkerProperties(q, g, v, b), l.push(ba), f = P(G),
                                        u && l.push({ x: g, y: v, ctx: F, type: ba.type, size: ba.size, color: f, borderColor: f, borderThickness: ba.borderThickness }));
                                    (fa.indexLabel || z.indexLabel || fa.indexLabelFormatter || z.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: fa, dataSeries: z, point: { x: g, y: v }, direction: 0 > y[q].y === a.axisY.reversed ? 1 : -1, color: e })
                                }
                        }
                        d();
                        b.moveTo(g, v);
        ...
        m.prototype.renderBubble = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)
                    for (var n = a.dataSeriesIndexes[h], r = this.data[n], q = r.dataPoints,
                            g = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (g = q[e].z, g > l && (l = g), g < k && (k = g));
                    ...
                    if (n = a.dataSeriesIndexes[h], r = this.data[n], q = r.dataPoints, 0 < q.length)
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                ...
                                var g = q[e].z,
                                    s = 2 * Math.max(Math.sqrt((l === k ? m / 2 : v + (m - v) / (l - k) * (g - k)) / Math.PI) << 0, 1),
                                ...
                                (q[e].indexLabel || r.indexLabel || q[e].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({ chartType: "bubble", dataPoint: q[e], dataSeries: r, point: { x: f, y: p }, direction: 1, bounds: { x1: f - g.size / 2, y1: p - g.size / 2, x2: f + g.size / 2, y2: p + g.size / 2 }, color: null })
                            }
                    ...
                    if (0 < n.length) {
                        ...
                        for (var r = 0, q = 0, e = 0; e < n.length; e++)
                            if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                                ...
                                c.globalAlpha = 1;
                                Math.sqrt((r - f) * (r - f) + (q - p) * (q - p)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width,
        ...
        m.prototype.renderCandlestick = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                v = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * p.width * (a.axisX.logarithmic ? Math.log(v) / Math.log(a.axisX.range) : Math.abs(v) / Math.abs(a.axisX.range)) << 0;
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var w = a.dataSeriesIndexes[m],
                        ...
                        x = t.dataPoints;
                    if (0 < x.length)
                        for (var F = 5 < v && t.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
                            if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] &&
                                ...
                                var C = k - v / 2 << 0,
                                    ...
                                    y = 0 === z % 2 ? 0 : 0.5,
                                    D = t.dataPointIds[l];
                                this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: w, dataPointIndex: l, x1: C, y1: h, x2: A, y2: n, x3: k, y3: r, x4: k, y4: q, borderThickness: z, color: e };
                                c.strokeStyle = e;
                                c.beginPath();
                                c.lineWidth = z;
                                b.lineWidth = Math.max(z, 4);
                                "candlestick" === t.type ? (c.moveTo(k - y, n), c.lineTo(k - y, Math.min(h, q)), c.stroke(), c.moveTo(k - y, Math.max(h, q)), c.lineTo(k - y, r), c.stroke(), ca(c, C, Math.min(h, q), A, Math.max(h, q), x[l].y[0] <= x[l].y[3] ? t.risingColor : f, z, e, F, F, !1, !1, t.fillOpacity), u && (e = P(D), b.strokeStyle = e, b.moveTo(k - y, n), b.lineTo(k - y, Math.min(h,
                                    q)), b.stroke(), b.moveTo(k - y, Math.max(h, q)), b.lineTo(k - y, r), b.stroke(), ca(b, C, Math.min(h, q), A, Math.max(h, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === t.type && (c.moveTo(k - y, n), c.lineTo(k - y, r), c.stroke(), c.beginPath(), c.moveTo(k, h), c.lineTo(C, h), c.stroke(), c.beginPath(), c.moveTo(k, q), c.lineTo(A, q), c.stroke(), u && (e = P(D), b.strokeStyle = e, b.moveTo(k - y, n), b.lineTo(k - y, r), b.stroke(), b.beginPath(), b.moveTo(k, h), b.lineTo(C, h), b.stroke(), b.beginPath(), b.moveTo(k, q), b.lineTo(A, q), b.stroke()));
                                (x[l].indexLabel || t.indexLabel ||
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = !1, m = !!a.axisY.reversed, w = 0; w < a.dataSeriesIndexes.length; w++) {
                    var t = a.dataSeriesIndexes[w],
                        ...
                        F = x.dataPoints;
                    if (0 < F.length)
                        for (var C = 5 < v && x.bevelEnabled ? !0 : !1, p = 0; p < F.length; p++)
                            if (F[p].getTime ? g = F[p].x.getTime() : g = F[p].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(F[p].y) && F[p].y.length && "number" === typeof F[p].y[0] && "number" === typeof F[p].y[1] && "number" === typeof F[p].y[2] && "number" === typeof F[p].y[3] && "number" === typeof F[p].y[4] && 5 === F[p].y.length) {
                                ...
                                var A = l - v / 2 << 0,
                                    ...
                                    D = 0 === y % 2 ? 0 : 0.5,
                                    S = F[p].whiskerColor ? F[p].whiskerColor : F[p].color ? x.whiskerColor ? x.whiskerColor : F[p].color : x.whiskerColor ? x.whiskerColor : e,
                                    R = "number" === typeof F[p].whiskerThickness ? F[p].whiskerThickness : "number" === typeof x.options.whiskerThickness ? x.whiskerThickness : y,
                                    E = F[p].whiskerDashType ? F[p].whiskerDashType : x.whiskerDashType,
                                    Z = s(F[p].whiskerLength) ? s(x.options.whiskerLength) ? v : x.whiskerLength : F[p].whiskerLength,
                                    Z = "number" === typeof Z ? 0 >= Z ? 0 : Z >= v ? v : Z : "string" === typeof Z ? parseInt(Z) * v / 100 > v ? v : parseInt(Z) * v / 100 : v,
                                    fa = 1 === Math.round(R) % 2 ? 0.5 : 0,
                                    la = F[p].stemColor ? F[p].stemColor : F[p].color ? x.stemColor ? x.stemColor : F[p].color : x.stemColor ? x.stemColor : e,
                                    ba = "number" === typeof F[p].stemThickness ? F[p].stemThickness : "number" === typeof x.options.stemThickness ? x.stemThickness : y,
                                    G = 1 === Math.round(ba) % 2 ? 0.5 : 0,
                                    J = F[p].stemDashType ? F[p].stemDashType :
                                    x.stemDashType,
                                    I = F[p].lineColor ? F[p].lineColor : F[p].color ? x.lineColor ? x.lineColor : F[p].color : x.lineColor ? x.lineColor : e,
                                    M = "number" === typeof F[p].lineThickness ? F[p].lineThickness : "number" === typeof x.options.lineThickness ? x.lineThickness : y,
                                ...
                                c.save();
                                0 < ba && (c.beginPath(), c.strokeStyle = la, c.lineWidth = ba, c.setLineDash && c.setLineDash(N(J, ba)), c.moveTo(l - G, h), c.lineTo(l - G, k), c.stroke(), c.moveTo(l - G, r), c.lineTo(l - G, n), c.stroke());
                                c.restore();
                                b.lineWidth = Math.max(y, 4);
                                c.beginPath();
                                ca(c, A, Math.min(q, h), z, Math.max(h, q), va, 0, e, m ? C : !1, m ? !1 : C, !1, !1, qa);
                                c.beginPath();
                                ca(c, A, Math.min(n, q), z, Math.max(q, n), V, 0, e, m ? !1 : C, m ? C : !1, !1, !1, qa);
                                c.beginPath();
                                c.lineWidth = y;
                                c.strokeStyle = e;
                                c.rect(A - D, Math.min(h, n) - D, z - A + 2 * D, Math.max(h, n) - Math.min(h, n) + 2 * D);
                                c.stroke();
                                c.save();
                                0 < M && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(N(Q, M)), c.strokeStyle = I, c.lineWidth = M, c.moveTo(A, q - K), c.lineTo(z, q - K), c.stroke());
                                c.restore();
                                c.save();
                                0 < R && (c.beginPath(), c.setLineDash && c.setLineDash(N(E, R)), c.strokeStyle = S, c.lineWidth = R, c.moveTo(l - Z / 2 << 0, r - fa), c.lineTo(l + Z / 2 << 0, r - fa),
                                    c.stroke(), c.moveTo(l - Z / 2 << 0, k + fa), c.lineTo(l + Z / 2 << 0, k + fa), c.stroke());
                                c.restore();
                                ...
                                (F[p].indexLabel || x.indexLabel || F[p].indexLabelFormatter ||
        ...
        m.prototype.renderRangeColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    p, l, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
                    1;
                    ...
                    if (0 < g.length)
                        for (var v =
                            ...
                            if (g[f].getTime ? k = g[f].x.getTime() : k = g[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                                ...
                                var m = a.axisX.reversed ? b + a.plotType.totalDataSeries * h / 2 - (a.previousDataSeriesCount + n) * h << 0 : b - a.plotType.totalDataSeries * h / 2 + (a.previousDataSeriesCount +
                                        n) * h << 0,
                                ...
                                if (p > l) { var t = p;
                                    ...
                                    l = t }
                                t = q.dataPointIds[f];
                                this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: f, x1: m, y1: p, x2: w, y2: l };
                                ca(c, m, p, w, l, b, 0, b, v, v, !1, !1, q.fillOpacity);
                                b = P(t);
                                u && ca(this._eventManager.ghostCtx, m, p, w, l, b, 0, null, !1, !1, !1, !1);
                                if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "rangeColumn",
                                    dataPoint: g[f],
                                    dataSeries: q,
                                    indexKeyword: 0,
                                    point: { x: m + (w - m) / 2, y: g[f].y[1] >= g[f].y[0] ? l : p },
                                    direction: g[f].y[1] >= g[f].y[0] ? -1 : 1,
                                    bounds: { x1: m, y1: Math.min(p, l), x2: w, y2: Math.max(p, l) },
                                    color: b
            ...
            function(a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var e = null,
                        ...
                        p = this.plotArea,
                        l = 0,
                        k, h, n, r, q, g, v, m = a.axisX.dataInfo.minDiff;
                    ...
                    c.rect(p.x1, p.y1, p.width, p.height);
                    c.clip();
                    u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(p.x1,
                    ...
                    for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                        var F = a.dataSeriesIndexes[x],
                            ...
                            D = 0;
                        if (z)
                            for (e = C._linkedSeries.id, t = 0; t < e; t++) !this.data[t].type.match(/(bar|column)/ig) ||
                        ...
                        l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? w : 1))) << 0 : 0.3 * this.width;
                        f && (l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
                            b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? w : 1))) << 0 : 0.03 * this.width);
                        t = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? p.height : p.width) * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / (z ? w : 1)) << 0;
                        ...
                        if (0 < A.length)
                            for (var E = C._colorSet, l = 0; l < A.length; l++) {
                                var e = C.lineColor = C.options.color ? C.options.color : E[0],
                                    S = {
                                        color: A[l].whiskerColor ? A[l].whiskerColor : A[l].color ? C.whiskerColor ? C.whiskerColor : A[l].color : C.whiskerColor ? C.whiskerColor : e,
                                        thickness: s(A[l].whiskerThickness) ? C.whiskerThickness : A[l].whiskerThickness,
                                        dashType: A[l].whiskerDashType ? A[l].whiskerDashType : C.whiskerDashType,
                                        length: s(A[l].whiskerLength) ? s(C.options.whiskerLength) ? t : C.options.whiskerLength : A[l].whiskerLength,
                                ...
                                var R = {
                                    color: A[l].stemColor ? A[l].stemColor : A[l].color ? C.stemColor ? C.stemColor : A[l].color : C.stemColor ? C.stemColor : e,
                                    thickness: A[l].stemThickness ? A[l].stemThickness : C.stemThickness,
                                ...
                                if (!(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax) && !s(A[l].y) && A[l].y.length && "number" === typeof A[l].y[0] && "number" === typeof A[l].y[1]) {
                                    ...
                                    b ? r = ja : g = ja;
                                    b ? (q = a.axisX.reversed ? h + (z ? w :
                                        1) * t / 2 - (z ? D - 1 : 0) * t << 0 : h - (z ? w : 1) * t / 2 + (z ? D - 1 : 0) * t << 0, g = a.axisX.reversed ? q - t << 0 : q + t << 0) : (n = a.axisX.reversed ? k + (z ? w : 1) * t / 2 - (z ? D - 1 : 0) * t << 0 : k - (z ? w : 1) * t / 2 + (z ? D - 1 : 0) * t << 0, r = a.axisX.reversed ? n - t << 0 : n + t << 0);
                                    !b && q > g && (ja = q, q = g, g = ja);
                                    b && n > r && (ja = n, n = r, r = ja);
                                    ja = C.dataPointIds[l];
                                    this._eventManager.objectMap[ja] = { id: ja, objectType: "dataPoint", dataSeriesIndex: F, dataPointIndex: l, x1: Math.min(n, r), y1: Math.min(q, g), x2: Math.max(r, n), y2: Math.max(g, q), isXYSwapped: b, stemProperties: R, whiskerProperties: S };
                                    y(c, Math.min(n, r),
                                        Math.min(q, g), Math.max(r, n), Math.max(g, q), e, S, R, b);
                                    u && y(this._eventManager.ghostCtx, n, q, r, g, e, S, R, b);
                                    if (A[l].indexLabel || C.indexLabel || A[l].indexLabelFormatter || C.indexLabelFormatter) this._indexLabels.push({ chartType: "error", dataPoint: A[l], dataSeries: C, indexKeyword: 0, point: { x: b ? A[l].y[1] >= A[l].y[0] ? n : r : n + (r - n) / 2, y: b ? q + (g - q) / 2 : A[l].y[1] >= A[l].y[0] ? g : q }, direction: A[l].y[1] >= A[l].y[0] ? -1 : 1, bounds: { x1: b ? Math.min(n, r) : n, y1: b ? q : Math.min(q, g), x2: b ? Math.max(n, r) : r, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b }),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < v.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < v.length; f++)
                            if (v[f].getTime ? h = v[f].x.getTime() : h = v[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(v[f].y) && v[f].y.length && "number" === typeof v[f].y[0] && "number" === typeof v[f].y[1]) {
                                ...
                                b = P(b);
                                u && ca(this._eventManager.ghostCtx, p, k, l, w, b, 0, null, !1, !1, !1, !1);
                                if (v[f].indexLabel || g.indexLabel || v[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: v[f], dataSeries: g, indexKeyword: 0, point: { x: v[f].y[1] >= v[f].y[0] ? p : l, y: k + (w - k) / 2 }, direction: v[f].y[1] >= v[f].y[0] ? -1 : 1, bounds: { x1: Math.min(p, l), y1: k, x2: Math.max(p, l), y2: w }, color: b }), this._indexLabels.push({
                                    chartType: "rangeBar",
                                    dataPoint: v[f],
                                    dataSeries: g,
                                    indexKeyword: 1,
                                    ...
                                    bounds: { x1: Math.min(p, l), y1: k, x2: Math.max(p, l), y2: w },
                                    color: b
                                })
                            }
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (var S = !0; g <
                            r.length; g++)
                            if (t = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !S)))
                                if (null !== r[g].y && r[g].y.length && "number" === typeof r[g].y[0] && "number" === typeof r[g].y[1]) {
                                    ...
                                    q || S ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || z === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (k[k.length -
                                        1].newLineDashArray = D, z = n.nullDataLineDashType, b.setLineDash(y)), b.lineTo(v, m), u && e.lineTo(v, m), k.push({ x: v, y: s })) : (b.beginPath(), b.moveTo(v, m), x = { x: v, y: m }, k = [], k.push({ x: v, y: s }), u && (e.beginPath(), e.moveTo(v, m))), S = q = !1) : (b.lineTo(v, m), k.push({ x: v, y: s }), u && e.lineTo(v, m), 0 == g % 250 && d());
                                    t = n.dataPointIds[g];
                                    this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: g, x1: v, y1: m, y2: s };
                                    g < r.length - 1 && (A !== (r[g].lineColor || C) || z !== (r[g].lineDashType || n.lineDashType)) && (d(),
                                        A = r[g].lineColor || C, k[k.length - 1].newStrokeStyle = A, b.strokeStyle = A, b.setLineDash && (r[g].lineDashType ? (z = r[g].lineDashType, k[k.length - 1].newLineDashArray = N(z, n.lineThickness), b.setLineDash(k[k.length - 1].newLineDashArray)) : (z = n.lineDashType, k[k.length - 1].newLineDashArray = D, b.setLineDash(D))));
                                    if (0 !== r[g].markerSize && (0 < r[g].markerSize || 0 < n.markerSize)) {
                                        var R = n.getMarkerProperties(g, v, s, b);
                                        f.push(R);
                                        var E = P(t);
                                        u && f.push({ x: v, y: s, ctx: e, type: R.type, size: R.size, color: E, borderColor: E, borderThickness: R.borderThickness });
                                        R = n.getMarkerProperties(g, v, m, b);
                                        f.push(R);
                                        E = P(t);
                                        u && f.push({ x: v, y: m, ctx: e, type: R.type, size: R.size, color: E, borderColor: E, borderThickness: R.borderThickness })
                                    }
                ...
                u && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(p.x1, p.y1,
                    p.width, p.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return { source: c, dest: this.plotArea.ctx, animationCallback: L.xClipAnimation, easingFunction: L.easing.linear, animationBase: 0 }
            }
        };
        m.prototype.renderRangeSplineArea = function(a) {
            function d(a, c) {
                ...
                if (0 < d.length) {
                    ...
                    d = w(y, 2);
                    b.lineTo(y[y.length - 1].x, y[y.length -
                        1].y);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                b.rect(p.x1, p.y1, p.width, p.height);
                b.clip();
                u && (e.beginPath(), e.rect(p.x1, p.y1, p.width,
                    p.height), e.clip());
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var k = a.dataSeriesIndexes[l],
                        h = this.data[k],
                        ...
                        for (g = !1; r < n.length; r++)
                            if (q = n[r].x.getTime ? n[r].x.getTime() : n[r].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g)))
                                if (null !== n[r].y && n[r].y.length && "number" === typeof n[r].y[0] && "number" === typeof n[r].y[1]) {
                                    ...
                                    s[s.length] = { x: q, y: g };
                                    y[y.length] = { x: q, y: m };
                                    r < n.length - 1 && (F !== (n[r].lineColor || x) || C !== (n[r].lineDashType || h.lineDashType)) && (F = n[r].lineColor || x, s[s.length - 1].newStrokeStyle = F, b.setLineDash && (n[r].lineDashType ? (C = n[r].lineDashType, s[s.length - 1].newLineDashArray = N(C, h.lineThickness)) : (C = h.lineDashType, s[s.length - 1].newLineDashArray = A)));
                                    ...
                                    g = !1
                                } else 0 < r && !g && (h.connectNullData ? b.setLineDash && (0 < s.length && (h.options.nullDataLineDashType || !n[r - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = z, C = h.nullDataLineDashType) : (d(A, x), s = [], y = [])), g = !0;
                        d(A, x);
                        X.drawMarkers(f)
                    }
                }
                u && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width,
                    this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(p.x1, p.y1, p.width, p.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return { source: c, dest: this.plotArea.ctx, animationCallback: L.xClipAnimation, easingFunction: L.easing.linear, animationBase: 0 }
            }
        };
        m.prototype.renderWaterfall = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    var t = "number" === typeof s.options.lineThickness ? Math.round(s.lineThickness) :
                        1,
                        x = 1 === Math.round(t) % 2 ? -0.5 : 0;
                    if (0 < w.length)
                        for (var F = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, A = null, z = null, p = 0; p < w.length; p++)
                            if (w[p].getTime ? n = w[p].x.getTime() : n = w[p].x, "number" !== typeof w[p].y) { if (0 < p && !C && s.connectNullData) var y = s.options.nullDataLineDashType || !w[p - 1].lineDashType ? s.nullDataLineDashType : w[p - 1].lineDashType;
                                C = !0 } else {
                                ...
                                h = 0 === s.dataPointEOs[p].cumulativeSumYStartValue ?
                                    r : a.axisY.convertValueToPixel(s.dataPointEOs[p].cumulativeSumYStartValue);
                                ...
                                var S = w[p].color ? w[p].color : 0 < w[p].y ? s.risingColor :
                                    s.fallingColor;
                                ca(c, l, k, D, h, S, 0, S, F, F, !1, !1, s.fillOpacity);
                                e = P(e);
                                u && ca(this._eventManager.ghostCtx, l, k, D, h, e, 0, null, !1, !1, !1, !1);
                                var R, S = l;
                                R = "undefined" !== typeof w[p].isIntermediateSum && !0 === w[p].isIntermediateSum || "undefined" !== typeof w[p].isCumulativeSum && !0 === w[p].isCumulativeSum ? 0 < w[p].y ? k : h : 0 < w[p].y ? h : k;
                                0 < p && A && (!C || s.connectNullData) && (C && c.setLineDash && c.setLineDash(N(y, t)), c.beginPath(), c.moveTo(A, z - x), c.lineTo(S, R - x), 0 < t && c.stroke(), u && (b.beginPath(), b.moveTo(A, z - x), b.lineTo(S, R - x), 0 < t &&
                                    b.stroke()));
                                C = !1;
                                A = D;
                                z = 0 < w[p].y ? k : h;
                                S = w[p].lineDashType ? w[p].lineDashType : s.options.lineDashType ? s.options.lineDashType : "shortDash";
                                c.strokeStyle = w[p].lineColor ? w[p].lineColor : s.options.lineColor ? s.options.lineColor : "#9e9e9e";
                                c.lineWidth = t;
                                c.setLineDash && (S = N(S, t), c.setLineDash(S));
                                (w[p].indexLabel || s.indexLabel || w[p].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "waterfall",
                                    dataPoint: w[p],
                                    dataSeries: s,
        ...
        var Y = function(a, d, c, b, e, f, p, l, k) {
            if (!(0 > c)) {
                ...
                a.save();
                a.globalAlpha = l;
                "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, p, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(),
                    a.arc(d.x, d.y, c, f, p, !1), 0 <= k && a.arc(d.x, d.y, k * c, p, f, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
                a.globalAlpha = 1;
                a.restore()
            }
        };
        m.prototype.renderPie = function(a) {
            function d() {
                if (h && n) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                        ...
                        l.indexLabelLineColor = f.indexLabelLineColor ? f.indexLabelLineColor :
                            h.options.indexLabelLineColor ? h.options.indexLabelLineColor : f.color ? f.color : h._colorSet[e % h._colorSet.length];
                        ...
                        l.indexLabelMaxWidth = f.indexLabelMaxWidth ? f.indexLabelMaxWidth : h.indexLabelMaxWidth ?
                            h.indexLabelMaxWidth : 0.33 * q.width;
                        ...
                        if (l.midAngle > Math.PI / 2 - t && l.midAngle < Math.PI / 2 + t) { if (0 === a || g[c].midAngle > l.midAngle) c = e;
                            ...
                            3 * Math.PI / 2 + t) { if (0 === b || g[d].midAngle > l.midAngle) d = e;
                            b++ }
                    ...
                    p = f = 0;
                    r = !1;
                    for (e = 0; e < n.length; e++) l = g[(c + e) % n.length], 1 < a && (l.midAngle > Math.PI / 2 - t && l.midAngle < Math.PI / 2 + t) && (f <= a / 2 && !r ? (l.hemisphere = "right", f++) : (l.hemisphere = "left", r = !0));
                    r = !1;
            ...
            function c(a) {
                ...
                for (b = 0; b < n.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * z * Math.cos(g[b].midAngle),
                            ...
                            l = !1;
                        if (n[b].exploded) { if (1E-9 < Math.abs(g[b].center.x - (F.x + e)) || 1E-9 < Math.abs(g[b].center.y - (F.y + f))) g[b].center.x = F.x + e * a, g[b].center.y = F.y + f * a, l = !0 } else if (0 < Math.abs(g[b].center.x - F.x) || 0 < Math.abs(g[b].center.y - F.y)) g[b].center.x = F.x + e * (1 - a), g[b].center.y = F.y + f * (1 - a), l = !0;
                        l && (e = {}, e.dataSeries = h, e.dataPoint =
                            h.dataPoints[b], e.index = b, k.toolTip.highlightObjects([e]));
                ...
                a.lineJoin = "round";
                for (b = b = 0; b < n.length; b++) c = g[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== h.indexLabelPlacement ? -(c.indexLabelTextBlock.width +
                    ...
                    c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, e), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -r : r), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
                a.save()
            }
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < n.length) {
                    ...
                    l =
                        0;
                    l = "right" === k.hemisphere ? F.x + Math.sqrt(Math.pow(u, 2) - Math.pow(c - F.y, 2)) : F.x - Math.sqrt(Math.pow(u, 2) - Math.pow(c - F.y, 2));
                    ...
                    for (p = 1; p < n.length; p++)
                        if (l = (a - p + g.length) % g.length, g[l].hemisphere !== g[a].hemisphere) { l = null; break } else if (g[l].indexLabelText && g[l].hemisphere === g[a].hemisphere && l !== a && (0 > b(g[l], g[a]) ||
                            ("right" === g[a].hemisphere ? g[l].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y : g[l].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y))) break;
                    else l = null;
                    r = l;
                    q = e(a);
                    p = l = 0;
                    0 > c ? (p = "right" === k.hemisphere ? r : q, h = c, null !== p && (r = -c, c = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - (g[p].indexLabelTextBlock.y + g[p].indexLabelTextBlock.height / 2), c - r < m && (l = -r, p = f(p, l, d + 1), +p.toFixed(x) > +l.toFixed(x) && (h = c > m ? -(c - m) : -(r - (p - l)))))) : 0 < c && (p = "right" === k.hemisphere ? q : r, h = c, null !== p && (r = c, c = g[p].indexLabelTextBlock.y -
                        g[p].indexLabelTextBlock.height / 2 - (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2), c - r < m && (l = r, p = f(p, l, d + 1), +p.toFixed(x) < +l.toFixed(x) && (h = c > m ? c - m : r - (l - p)))));
            ...
            function p() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    if (h.radius || !h.radius && "undefined" !== typeof h.innerRadius && null !== h.innerRadius && z - d <= D) l = !1;
                    l && (z -= d);
                    d = 0;
                        ...
                        for (var t, s, a = 0; a < n.length; a++) {
                            ...
                            if (null !== A) {
                                ...
                                var y = 0,
                                    y = b(t, s) - m;
                                if (0 > y) {
                                    for (var C = s = 0, J = 0; J < n.length; J++) J !== a && g[J].hemisphere === p.hemisphere && (g[J].indexLabelTextBlock.y < p.indexLabelTextBlock.y ? s++ : C++);
                                    s = y / (s + C || 1) * C;
                                    var C = -1 * (y - s),
                                        I = J = 0;
                                    "right" === p.hemisphere ? (J = f(a, s), C = -1 * (y - J), I = f(A, C), +I.toFixed(x) < +C.toFixed(x) && +J.toFixed(x) <= +s.toFixed(x) && f(a, -(C - I))) : (J = f(A, s), C = -1 * (y - J), I = f(a, C), +I.toFixed(x) < +C.toFixed(x) && +J.toFixed(x) <= +s.toFixed(x) && f(A, -(C - I)))
                                }
                            }
                        }
                    } else
                        for (a = 0; a < n.length; a++) p = g[a], u = "pie" === h.type ? 0.7 * z : 0.8 * z, A = F.x + u * Math.cos(p.midAngle), s = F.y + u * Math.sin(p.midAngle), p.indexLabelTextBlock.x = A, p.indexLabelTextBlock.y = s;
                    for (a = 0; a < n.length; a++)
                        if (p = g[a], A = p.indexLabelTextBlock.measureText(), 0 !== A.height && 0 !== A.width) A = A = 0, "right" === p.hemisphere ? (A = q.x2 - (p.indexLabelTextBlock.x + p.indexLabelTextBlock.width + r), A *= -1) : A = q.x1 - (p.indexLabelTextBlock.x -
                                ...
                                if (null !== p) {
                                    ...
                                    if (k = 0 > y) {
                                        ...
                                        var q = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height / 2,
                                            m = t.indexLabelTextBlock.y + t.indexLabelTextBlock.height /
                                            2,
                                            v = l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2,
                                            s = l.indexLabelTextBlock.x + l.indexLabelTextBlock.width,
                                            B = l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2;
                                        k = t.indexLabelTextBlock.x + t.indexLabelTextBlock.width < l.indexLabelTextBlock.x - r || k > s + r || q > B + r || m < v - r ? !1 : !0
                                    }
            ...
            function l() {
                ...
                k.title && (k.title.dockInsidePlotArea ||
                    "center" === k.title.horizontalAlign && "center" === k.title.verticalAlign) && k.title.render();
                if (k.subtitles)
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h = this.data[a.dataSeriesIndexes[0]],
                    ...
                    y = 0;
                a = !1;
                for (var A = 0; A < n.length; A++) y += Math.abs(n[A].y), !a && ("undefined" !== typeof n[A].indexLabel && null !== n[A].indexLabel && 0 < n[A].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof n[A].label && null !== n[A].label && 0 < n[A].label.toString().length) && (a = !0);
                if (0 !== y) {
                    a = a || "undefined" !== typeof h.indexLabel && null !== h.indexLabel && 0 < h.indexLabel.toString().length;
                    var z = "inside" !== h.indexLabelPlacement &&
                        a ? 0.75 * Math.min(q.width, q.height) / 2 : 0.92 * Math.min(q.width, q.height) / 2;
                    h.radius && (z = Pa(h.radius, z));
                    var D = "undefined" !== typeof h.innerRadius && null !== h.innerRadius ? Pa(h.innerRadius, z) : 0.7 * z;
                    h.radius = z;
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                        ...
                        for (b = 0; b < n.length; b++) {
                            ...
                            d > c && Y(k.plotArea.ctx, g[b].center, g[b].radius,
                                f, h.type, c, d, h.fillOpacity, g[b].percentInnerRadius);
                            if (e) break
                        }
                        l()
        ...
        var oa = function(a, d, c, b) {
            ...
            0 >= Math.round(d.y4 - d.y1) || (a.save(), a.globalAlpha = c, a.beginPath(), a.moveTo(Math.round(d.x1), Math.round(d.y1)), a.lineTo(Math.round(d.x2), Math.round(d.y2)), a.lineTo(Math.round(d.x3), Math.round(d.y3)), a.lineTo(Math.round(d.x4), Math.round(d.y4)), "undefined" !== d.x5 && (a.lineTo(Math.round(d.x5),
        ...
        m.prototype.renderFunnel = function(a) {
            function d() { for (var a = 0, b = [], c = 0; c < x.length; c++) { if ("undefined" === typeof x[c].y) return -1;
                    x[c].y = "number" === typeof x[c].y ? x[c].y : 0;
                    a += Math.abs(x[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < x.length; c++) b.push(Math.abs(x[c].y) * D / a); return b }
            ...
            function c() {
                ...
                for (var d = [], g = 0, h = 0; h < x.length; h++) { if ("undefined" === typeof x[h].y) return -1;
                    ...
                    g += Math.abs(x[h].y) }
                if (0 === g) return -1;
                for (var p = d[0] = 0, l = 0, k, n, b = b - a, p = !1, h = 0; h < x.length; h++) a = Math.abs(x[h].y) * f / g, p ? k = 0 == Number(c.toFixed(3)) ? 0 : a / c : (n = aa * aa * b * b - 4 * Math.abs(aa) * a, 0 > n ? (n = c, p = (b + n) * (e - l) / 2, a -= p, k = e - l, l += e - l, k += 0 == n ? 0 : a / n, l += a / n, p = !0) : (k = (Math.abs(aa) * b - Math.sqrt(n)) / 2, n = b - 2 * k / Math.abs(aa), l += k, l > e && (l -= k, n = c, p = (b + n) * (e - l) / 2, a -= p, k = e -
                    l, l += e - l, k += a / n, l += a / n, p = !0), b = n)), d.push(k);
                return d
            }

            function b() {
                if (t && x) {
                    for (var a, b, c, d, e, f, h, l, p, k, n, q, r, m, v = [], B = [], w = { percent: null, total: null }, A = null, z = 0; z < x.length; z++) m = O[z], m = "undefined" !== typeof m.x5 ? (m.y2 + m.y4) / 2 : (m.y2 + m.y3) / 2, m = g(m).x2 + 1, v[z] = M - m - V;
                    m = 0.5 * V;
                    for (var z = 0, F = x.length - 1; z < x.length || 0 <= F; z++, F--) {
                        ...
                        c = b.indexLabelPlacement || t.indexLabelPlacement ||
                            "outside";
                        ...
                        k = "number" === typeof b.indexLabelLineThickness ? b.indexLabelLineThickness :
                            "number" === typeof t.indexLabelLineThickness ? t.indexLabelLineThickness : 2;
                        ...
                        "inside" === t.indexLabelPlacement && (v[z] = z !== ca ? t.reversed ? O[z].x2 - O[z].x1 : O[z].x3 - O[z].x4 : O[z].x3 -
                            O[z].x6, 20 > v[z] && (v[z] = z !== ca ? t.reversed ? O[z].x3 - O[z].x4 : O[z].x2 - O[z].x1 : O[z].x2 - O[z].x1, v[z] /= 2));
                        r = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth : v[z];
                        if (r > v[z] || 0 > r) r = v[z];
                        B[z] = "inside" === t.indexLabelPlacement ? O[z].height : !1;
                        w = y.getPercentAndTotal(t, b);
                        if (t.indexLabelFormatter || b.indexLabelFormatter) A = { chart: y.options, dataSeries: t, dataPoint: b, total: w.total, percent: w.percent };
                        b = b.indexLabelFormatter ? b.indexLabelFormatter(A) : b.indexLabel ? y.replaceKeywordsWithValue(b.indexLabel,
                            b, t, z) : t.indexLabelFormatter ? t.indexLabelFormatter(A) : t.indexLabel ? y.replaceKeywordsWithValue(t.indexLabel, b, t, z) : b.label ? b.label : "";
                        0 >= k && (k = 0);
                        1E3 > r && 1E3 - r < m && (r += 1E3 - r);
                        P.roundRect || za(P);
                        c = new ia(P, { fontSize: f, fontFamily: l, fontColor: e, fontStyle: h, fontWeight: p, horizontalAlign: c, backgroundColor: d, maxWidth: r, maxHeight: !1 === B[z] ? q ? 4.28571429 * f : 1.5 * f : B[z], text: b, padding: da });
                        c.measureText();
                        H.push({
                            textBlock: c,
                            id: t.reversed ? F : z,
            ...
            function e() {
                ...
                e = !1;
                c = 0;
                for (var g, h = M - $ - V / 2, h = t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth > h ? h : t.indexLabelMaxWidth : h, l = H.length - 1; 0 <= l; l--) { g = x[H[l].id];
                    c = H[l];
                    d = c.textBlock;
                    ...
                    f.push(c) }
                if (e)
                    for (l = H.length - 1; 0 <= l; l--) a = O[l], H[l].textBlock.maxWidth = f[f.length - (l + 1)], H[l].textBlock.measureText(),
            ...
            function f() {
                ...
                if ("inside" !== t.indexLabelPlacement)
                    for (var e = 0; e < O.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = O[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = t.reversed ? "undefined" !== typeof a.x5 ? c > va ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < va ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + V, H[e].textBlock.y = c - H[e].height / 2, t.reversed ? (H[e].textBlock.y + H[e].height >
                        T + C && (H[e].textBlock.y = T + C - H[e].height), H[e].textBlock.y < qa - C && (H[e].textBlock.y = qa - C)) : (H[e].textBlock.y < T - C && (H[e].textBlock.y = T - C), H[e].textBlock.y + H[e].height > qa + C && (H[e].textBlock.y = qa + C - H[e].height)));
                else
            ...
            function p() {
                function a(b,
                    c) { var d; if (0 > b || b >= H.length) return 0; var e, f = H[b].textBlock; if (0 > c) { c *= -1;
                        e = r(b);
                        d = l(e, b); if (d >= c) return f.y -= c, c; if (0 == b) return 0 < d && (f.y -= d), d;
                        d += a(e, -(c - d));
                        0 < d && (f.y -= d); return d }
                    e = q(b);
                    d = l(b, e); if (d >= c) return f.y += c, c; if (b == O.length - 1) return 0 < d && (f.y += d), d;
                    d += a(e, c - d);
                    0 < d && (f.y += d); return d }
                ...
                function b() {
                    ...
                    for (var l, p = 1; p < h; p++) {
                        e = p * f;
                        for (var n = H.length - 1; 0 <= n; n--) !H[n].isDirty && (H[n].textBlock.y < e && H[n].textBlock.y + H[n].height > e) && (l = q(n), !(l >= H.length - 1) &&
                    ...
                    for (l = O.length - 1; 0 < l; l--)
                        if (!H[l].isDirty) {
                            ...
                            if (H[l].textBlock.y < H[e].textBlock.y + H[e].height) {
                                d = d || l;
                                f = l;
                                for (h = 0; H[f].textBlock.y < H[e].textBlock.y + H[e].height + da;) { a = a || H[f].textBlock.y + H[f].height;
                                    h += H[f].height;
                                    h += da;
                                    f = e; if (0 >= f) { f = 0;
                                        h += H[f].height; break }
                ...
                function c(a, b, d) { var e = [],
                        f = 0,
                        g = 0; for (a = Math.abs(a); d <= b; d++) e.push(O[d]);
            ...
            function l(a, b) { return (b < O.length ? H[b].textBlock.y : t.reversed ? T + C : qa + C) - (0 > a ? t.reversed ? qa - C : T - C : H[a].textBlock.y + H[a].height + da) }
            ...
            function k(a, b, c) {
                ...
                if (0 === Y.length) l = ga;
                    ...
                    e = C * (1 != Y.length || 0 != Y[0] && Y[0] != O.length - 1 ?
                        2 : 1) / h();
                    for (var q = 0; q < O.length; q++) { if (1 == Y.length && 0 == Y[0]) { if (0 === q) { l.push(ga[q]);
            ...
            function q(a) { for (a += 1; a <= O.length && a != O.length && H[a].isDirty; a++); return a }
            ...
            var y = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var t = this.data[a.dataSeriesIndexes[0]], x = t.dataPoints, F = this.plotArea, C = 0.025 * F.width, A = 0.01 * F.width, z = 0, D = F.height - 2 * C, E = Math.min(F.width - 2 * A, 2.8 * F.height), I = !1, R = 0; R < x.length; R++)
                    if (!I && ("undefined" !== typeof x[R].indexLabel && null !== x[R].indexLabel && 0 < x[R].indexLabel.toString().length) && (I = !0), !I && ("undefined" !==
                            typeof x[R].label && null !== x[R].label && 0 < x[R].label.toString().length) && (I = !0), !I && "function" === typeof t.indexLabelFormatter || "function" === typeof x[R].indexLabelFormatter) I = !0;
                I = I || "undefined" !== typeof t.indexLabel && null !== t.indexLabel && 0 < t.indexLabel.toString().length;
                "inside" !== t.indexLabelPlacement && I || (A = (F.width - 0.75 * E) / 2);
                var R = F.x1 + A,
                    M = F.x2 - A,
                    Z = F.y1 + C,
                    Q = F.y2 - C,
                ...
                if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                    ...
                    if (-1 !== R) {
                        ...
                        if (t.reversed)
                            for (G = 0; G < R.length; G++) E[G] < va ? (a.push(K), A.push(X), ca = G) : (a.push((E[G] - T + aa * W) / aa), A.push((E[G] - T + ea * $) / ea));
                        else
                            for (G = 0; G < R.length; G++) E[G] < va ? (a.push((E[G] - T + aa * W) / aa), A.push((E[G] - T + ea * $) / ea), ca = G) : (a.push(K), A.push(X));
                        for (G = 0; G < R.length - 1; G++) U = t.reversed ?
                            x[x.length - 1 - G].color ? x[x.length - 1 - G].color : t._colorSet[(x.length - 1 - G) % t._colorSet.length] : x[G].color ? x[G].color : t._colorSet[G % t._colorSet.length], G === ca ? O.push({ x1: a[G], y1: E[G], x2: A[G], y2: E[G], x3: X, y3: va, x4: A[G + 1], y4: E[G + 1], x5: a[G + 1], y5: E[G + 1], x6: K, y6: va, id: G, height: E[G + 1] - E[G], color: U }) : O.push({ x1: a[G], y1: E[G], x2: A[G], y2: E[G], x3: A[G + 1], y3: E[G + 1], x4: a[G + 1], y4: E[G + 1], id: G, height: E[G + 1] - E[G], color: U });
                        var da = 2,
                            H = [],
                            ha = !1,
                            Y = [],
                        ...
                        a = a = 0;
                        Aa(Y);
                        for (G = 0; G < x.length; G++) x[G].exploded && (R = !0, t.reversed ?
                        ...
                        if (I && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) { p(); for (G = 0; G < x.length; G++) H[G].isDirty || (a = H[G].textBlock.x + H[G].width, a = (M - a) / 2, 0 == G && (z = a), z > a && (z = a)); for (G = 0; G < O.length; G++) O[G].x1 += z, O[G].x2 += z, O[G].x3 += z, O[G].x4 += z, O[G].x5 && (O[G].x5 += z, O[G].x6 += z), H[G].textBlock.x += z }
                        for (G = 0; G < O.length; G++) z = O[G], oa(P, z, t.fillOpacity), ga.push(z.y1);
                        w(P);
                        ...
                        this.funnelPyramidClickHandler = function(a) {
                            ...
                            if (!ha && !y.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) &&
                                (b = t.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) { a = b; if ("funnel" === t.type || "pyramid" === t.type) t.reversed ? x[x.length - 1 - a].exploded = x[x.length - 1 - a].exploded ? !1 : !0 : x[a].exploded = x[a].exploded ? !1 : !0;
                                k(y, b, 500) }
                        };
                        return { source: P, dest: this.plotArea.ctx, animationCallback: function(a, b) { L.fadeInAnimation(a, b);
                                1 <= a && (k(y, -1, 500), w(y.plotArea.ctx || y.ctx)) }, easingFunction: L.easing.easeInQuad, animationBase: 0 }
                    }
                }
            }
        };
        ...
        m.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                try { var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    g && 0 < g.length && (h = Da(g[2]), a = Da(g[1])) } catch (l) {}
                g = null;
        ...
        E.prototype.setLayout = function() {
            ...
            var k = [],
                h = [];
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, p = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height) : "center" === this.verticalAlign && (this.orientation = "vertical", c = this.horizontalAlign,
                ...
                if (r.dataPoints && r.dataPoints.length)
                    if ("pie" !== r.type && "doughnut" !== r.type && "funnel" !== r.type && "pyramid" !== r.type) {
                        var q = r.legendMarkerType = r.legendMarkerType ? r.legendMarkerType : "line" !== r.type && "stepLine" !== r.type && "spline" !== r.type && "scatter" !== r.type && "bubble" !== r.type || !r.markerType ?
                            "error" === r.type && r._linkedSeries ? r._linkedSeries.legendMarkerType ? r._linkedSeries.legendMarkerType : I.getDefaultLegendMarker(r._linkedSeries.type) : I.getDefaultLegendMarker(r.type) : r.markerType,
                            g = r.legendText ? r.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: r, dataPoint: null }) : r.name,
                            ...
                            w = r.legendMarkerBorderColor ? r.legendMarkerBorderColor : r.markerBorderColor,
                        ...
                        for (var x = 0; x < r.dataPoints.length; x++) {
                            var y = r.dataPoints[x],
                                q = y.legendMarkerType ? y.legendMarkerType : r.legendMarkerType ? r.legendMarkerType : I.getDefaultLegendMarker(r.type),
                                g = y.legendText ? y.legendText : r.legendText ? r.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: r, dataPoint: y }) : y.name ? y.name : "DataPoint: " + (x + 1),
                                m = y.legendMarkerColor ? y.legendMarkerColor :
                                r.legendMarkerColor ? r.legendMarkerColor : y.color ? y.color : r.color ? r.color : r._colorSet[x % r._colorSet.length],
                                u = 0.75 * this.lineHeight,
                                w = y.legendMarkerBorderColor ? y.legendMarkerBorderColor : r.legendMarkerBorderColor ? r.legendMarkerBorderColor : y.markerBorderColor ? y.markerBorderColor : r.markerBorderColor,
                                t = y.legendMarkerBorderThickness ? y.legendMarkerBorderThickness : r.legendMarkerBorderThickness ? r.legendMarkerBorderThickness : y.markerBorderThickness || r.markerBorderThickness ? Math.max(1, Math.round(0.2 * u)) : 0,
                                g = this.chart.replaceKeywordsWithValue(g,
                                    y, r, x),
                                q = { markerType: q, markerColor: m, text: g, textBlock: null, chartType: r.type, markerSize: u, dataSeriesIndex: n, dataPointIndex: x, markerBorderColor: w, markerBorderThickness: t };
                            (y.showInLegend || r.showInLegend && !1 !== y.showInLegend) && k.push(q)
                        }
            ...
            if (0 < k.length) {
                ...
                for (n = 0; n < k.length; n++) {
                    ...
                    if (!(0 >= p || "undefined" === typeof p || 0 >= w || "undefined" === typeof w)) {
            ...
            this.items = k;
            for (n = 0; n < this.items.length; n++) q = k[n], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] = { id: q.id, objectType: "legendItem", legendItemIndex: n, dataSeriesIndex: q.dataSeriesIndex, dataPointIndex: q.dataPointIndex };
            this.markerSize = u;
            this.rows = h;
        ...
        E.prototype.render = function() {
            ...
            for (var l = 0, k = 0; k < p.length; k++) {
                for (var h = p[k], n = 0, r = 0; r < h.items.length; r++) {
                    ...
                    this.ctx.clip();
                    if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, m + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, m + this.lineHeight / 2), this.ctx.stroke(), s -=
                        0.1 * this.lineHeight;
                    if ("error" === q.chartType) { this.ctx.strokeStyle = this.errorMarkerColor[0];
                        this.ctx.lineWidth = f / 8;
                        this.ctx.beginPath(); var u = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight,
                    ...
                    X.drawMarker(g +
                        f / 2, m + this.lineHeight / 2, this.ctx, q.markerType, "error" === q.chartType || "line" === q.chartType || "spline" === q.chartType ? q.markerSize / 2 : q.markerSize, q.markerColor, q.markerBorderColor, q.markerBorderThickness);
                    q.textBlock.x = g + c + f;
        ...
        I.prototype.getDataPointAtX = function(a, d) {
            ...
            for (;;) {
                ...
                if (0 <= f && f < this.dataPoints.length) { var b = this.dataPoints[f],
                    ...
                    b = r;
                    b <= l ? l = b : 0 < p ? k++ : h++; if (1E3 < k && 1E3 < h) break } else if (0 > n - e && n + e >= this.dataPoints.length) break; - 1 === p ? (e++, p = 1) : p = -1
            }
        ...
        I.prototype.getDataPointAtXY = function(a, d, c) {
            ...
            if ("none" !== this.chart.plotInfo.axisPlacement)
                if (r = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: d }), this.axisX.logarithmic) var q = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
                    r = 1 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * Math.log(r /
                        this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
                else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, r = 0 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * (r - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
            for (;;) {
                f = 0 < p ? r + e : r - e;
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "error":
                                a >=
                                    q.x1 && (a <= q.x2 && d >= q.y1 && d <= q.y2) && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y1 - d), Math.abs(q.y2 - d)) }), l = !0);
                                break;
                            case "line":
                            case "stepLine":
                            case "spline":
                            ...
                            case "boxAndWhisker":
                                if (a >=
                                    q.x1 - q.borderThickness / 2 && a <= q.x2 + q.borderThickness / 2 && d >= q.y4 - q.borderThickness / 2 && d <= q.y1 + q.borderThickness / 2 || Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness && d >= q.y1 && d <= q.y4) b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d)) }), l = !0;
                                break;
                            case "candlestick":
                                if (a >= q.x1 - q.borderThickness / 2 && a <= q.x2 + q.borderThickness / 2 && d >= q.y2 - q.borderThickness / 2 && d <= q.y3 + q.borderThickness / 2 || Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness &&
                                    d >= q.y1 && d <= q.y4) b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d)) }), l = !0;
                                break;
                            case "ohlc":
        ...
        D.prototype.createExtraLabelsForLog = function(a) {
            ...
            if (!(5 < a)) {
                ...
                if (Math.log(this.range) / Math.log(d / this.viewportMinimum) <
                    this.noTicks - 1) { for (var c = D.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), b = Math.ceil(this.viewportMinimum / c) * c; b < d; b += c) b < this.viewportMinimum || this.logLabelValues.push(b);
        ...
        D.prototype.createLabels = function() {
            ...
            var r = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [],
                q = r.length ? s(this.scaleBreaks.firstBreakIndex) ?
            ...
            if (this.labelAutoFit || this.options.labelAutoFit)
                if (s(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
                    if (f = 0.9 * l >> 0, q = 0, !this.chart.panEnabled &&
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), n = (h - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !s(this.options.labelWrap)) this.labelWrap ? s(this.options.labelMaxWidth) ?
                                        ...
                                        if (s(this.options.labelWrap))
                                            ...
                                            else if (w === c && (0 === w && q + this._labels[w + 1].textBlock.measureText().width - 2 * f > r || w === this._labels.length - 1 && q + this._labels[w - 1].textBlock.measureText().width - 2 * f > r || 0 < w && w < this._labels.length - 1 && q + this._labels[w + 1].textBlock.measureText().width - 2 * f > r &&
        ...
        D.setLayout = function(a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                    for (var m = q[g].scaleBreaks._appliedBreaks, u = 0; u < m.length && !(m[u].startValue > q[g].viewportMaximum); u++) m[u].endValue < q[g].viewportMinimum || (s(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex =
                        u), m[u].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = u));
            for (var w = u = 0, t = 0, x = 0, y = 0, C = 0, A = 0, z, D, E = l = 0, I, J, L, m = I = J = L = !1, g = 0; g < q.length; g++) q[g] && q[g].title && (q[g]._titleTextBlock = new ia(q[g].ctx, {
                text: q[g].title,
                horizontalAlign: "center",
                ...
                if ("normal" === e) {
                    for (var x = [], y = [], C = [], A = [], M = [], N = [], P = [], Q = []; 4 > u;) {
                        var G = 0,
                            ...
                            aa = 0;
                        if (c && 0 < c.length)
                            for (C = [], g = O = 0; g < c.length; g++) C.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += C[g], K += c[g] && !n.isNavigator ? c[g].margin : 0;
                        ...
                        if (a && 0 < a.length)
                            for (x = [], g = U = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates = {}), a[g].lineCoordinates.width = Math.abs(k - p), a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.width ?
                                a[g].titleMaxWidth : a[g].lineCoordinates.width), x.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateHeight() : 0)), U += x[g], e += a[g] && !n.isNavigator ? a[g].margin : 0;
                        else x.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
                        M.push(x);
                        if (d && 0 < d.length)
                            for (y = [], g = X = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(k - p), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width),
                                y.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), X += y[g], Y += d[g] && !n.isNavigator ? d[g].margin : 0;
                        else y.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                        N.push(y);
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates.x1 = p, k = Math.round(f.x2 - aa - $ > n.width - r ? n.width - r : f.x2 - aa - $), a[g]._labels && 1 < a[g]._labels.length && (l = h = 0, h = a[g]._labels[1], l = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1], w = h.textBlock.width * Math.cos(Math.PI /
                                ...
                                n.sessionVariables.axisX.height = U : n.sessionVariables.axisX.height : n.sessionVariables.axisX.height = U, l = Math.round(f.y2 - U - e + G), h = Math.round(f.y2), a[g].lineCoordinates.x2 = k, a[g].lineCoordinates.width = k - p, a[g].lineCoordinates.y1 = l, a[g].lineCoordinates.y2 = l + a[g].lineThickness / 2, "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + x[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - ("inside" === a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 +
                                    a[g].lineThickness / 2), a[g].bounds = { x1: p, y1: l, x2: k, y2: h - (U + e - x[g] - G), width: k - p, height: h - l }), G += x[g] + a[g].margin;
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 = Math.round(f.x1 + O + K), d[g].lineCoordinates.x2 = Math.round(f.x2 - aa - $ > n.width - r ? n.width - r : f.x2 - aa - $), d[g].lineCoordinates.width = Math.abs(k - p), d[g]._labels && 1 < d[g]._labels.length && (h = d[g]._labels[1], l = "dateTime" === d[g].valueType ? d[g]._labels[d[g]._labels.length - 2] : d[g]._labels[d[g]._labels.length - 1], w = h.textBlock.width * Math.cos(Math.PI /
                                ...
                                l + X + Y - V, d[g].lineCoordinates.y2 = l, "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[g - 1].bounds.y1 - y[g] + (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0)), d[g].bounds = { x1: p, y1: l + (X + Y - y[g] - V), x2: k, y2: h, width: k - p, height: h - l }, V += y[g] + d[g].margin;
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) K = n.isNavigator ? 0 : 10, c[g] && (p = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : r, l = Math.round(f.y1 +
                                ...
                                c[g].lineCoordinates.x1 + c[g].lineThickness / 2), c[g].bounds = { x1: p - (C[g] + T), y1: l, x2: k, y2: h, width: k - p, height: h - l }, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), T += C[g] + c[g].margin);
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) b[g] && (p = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), k = Math.round(p), K = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height /
                                2 : 0, l = Math.round(f.y1 + X + Y < Math.max(K, r) ? Math.max(K, r) : f.y1 + X + Y), K = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, h = Math.round(f.y2 - (U + e + K)), b[g].lineCoordinates = { x1: p + W, y1: l, x2: p + W, y2: h, height: Math.abs(h - l) }, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (A[g] - b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2, b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness /
                                    2), b[g].bounds = { x1: p, y1: l, x2: k + (A[g] + W), y2: h, width: k - p, height: h - l }, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.height ? b[g].titleMaxWidth : b[g].lineCoordinates.height), W += A[g] + b[g].margin);
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (z = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase :
                                a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1, p = a[g]._labels[a[g]._labels.length - ("dateTime" === a[g].valueType ? 2 : 1)].position, p = a[g].getApparentDifference(a[g].viewportMinimum, p), D = a[g].logarithmic ? (1 < p ? Math.log(p) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < p ? p * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1));
                        if (d && 0 < d.length)
                            for (g =
                                ...
                                p), D = d[g].logarithmic ? (1 < p ? Math.log(p) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < p ? p * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1);
                    ...
                    for (N = []; 4 > u;) {
                        ...
                        N.push(w);
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, p = Math.round(f.x1 + W + e), k = Math.round(f.x2 - U - Y > n.width - 10 ? n.width - 10 : f.x2 - U - Y), c[g].labelAutoFit && !s(x) && (0 < !a.length && (p = 0 > c[g].labelAngle ? Math.max(p, x) : 0 === c[g].labelAngle ? Math.max(p, x / 2) : p), 0 < !d.length && (k = 0 < c[g].labelAngle ? k - y / 2 : 0 === c[g].labelAngle ? k - y / 2 : k)), c[g].lineCoordinates.x1 = p, c[g].lineCoordinates.x2 =
                                k, c[g].lineCoordinates.width = Math.abs(k - p), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, p = Math.round(f.x1 + W + e), k = Math.round(f.x2 - U - Y > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - U - Y), b[g] && b[g].labelAutoFit && !s(C) && (0 < !a.length && (p = 0 < b[g].labelAngle ? Math.max(p, C) : 0 === b[g].labelAngle ? Math.max(p, C / 2) : p), 0 < !d.length && (k -= A / 2)),
                                b[g].lineCoordinates.x1 = p, b[g].lineCoordinates.x2 = k, b[g].lineCoordinates.width = Math.abs(k - p), b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width);
                        if (c && 0 < c.length)
                            for (r = [], g = T = 0; g < c.length; g++) r.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), T += r[g] + c[g].margin, K += c[g].margin;
                        else r.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                        D.push(r);
                        if (b && 0 < b.length)
                            for (z = [],
                                g = V = 0; g < b.length; g++) z.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), V += z[g], $ += b[g].margin;
                        else z.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                        t.push(z);
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) 0 < c[g]._labels.length && (h = c[g]._labels[0], l = c[g]._labels[c[g]._labels.length - 1], x = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), y = l.textBlock.width * Math.cos(Math.PI /
                                180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle)));
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) b[g] && 0 < b[g]._labels.length && (h = b[g]._labels[0], l = b[g]._labels[b[g]._labels.length - 1], C = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), A = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height -
                                l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle)));
                        if (n.panEnabled)
                        ...
                        if (c && 0 < c.length)
                            for (g = c.length - 1; 0 <= g; g--) l = Math.round(f.y2), h = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = l - (r[g] + c[g].margin + X), c[g].lineCoordinates.y2 = l - (r[g] + c[g].margin +
                                ...
                                X += r[g] + c[g].margin;
                        if (b && 0 < b.length)
                            for (g = b.length - 1; 0 <= g; g--) b[g] && (l = Math.round(f.y1), h = Math.round(f.y1 + (z[g] + b[g].margin + G)), b[g].lineCoordinates.y1 = h, b[g].lineCoordinates.y2 = h, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - z[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = { x1: p, y1: l + (b[g].margin + G), x2: k, y2: h, width: k - p, height: V }, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth :
                                b[g].lineCoordinates.width), G += z[g] + b[g].margin);
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) {
                                ...
                                h = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > n.height - Math.max(K, 10) ? n.height - Math.max(K, 10) : f.y2 - T) : f.y2 > n.height - Math.max(K, 10) ? n.height -
                                    Math.max(K, 10) : f.y2;
                                if (c && 0 < c.length)
                                ...
                                "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.x1 = a[g].lineCoordinates.x1 - (E[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height :
                            ...
                            for (g = 0; g < d.length; g++) {
                                ...
                                if (c && 0 < c.length)
                                    for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ?
                                        Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, p = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - U : p);
                                if (b && 0 < b.length)
                                ...
                                "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (w[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) - ("outside" === d[g].tickPlacement ? d[g].tickLength : 0), d[g].lineCoordinates.x2 = d[g].lineCoordinates.x1 +
                                    d[g].lineThickness / 2);
                                d[g].bounds = { x1: d[g].lineCoordinates.x1, y1: l, x2: k + w[g] + Q, y2: h, width: k - p, height: h - l };
        ...
        D.render = function(a, d, c, b, e) {
            ...
            if (b && 0 < b.length)
                for (l = 0; l < b.length; l++) b[l].renderGrid(),
        ...
        D.prototype.renderLabelsTicksAndTitle = function() {
            ...
            if ("undefined" === typeof this.options.interval) {
                if ("bottom" === this._position || "top" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ?
                                1 : 1.2, k, l = this.viewportMaximum, m = this.lineCoordinates.width / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) { r = this._labels[h]; if (r.position < this.viewportMinimum) break;
                            r.position > this.viewportMaximum || !(h === this._labels.length - 1 || k < Math.log(l / r.position) * m / e) || (c.push(r), l = r.position, k = r.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + r.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle))) }
                        this._labels = c
                    } else {
                        for (h = 0; h < this._labels.length; h++) r = this._labels[h], r.position <
                            this.viewportMinimum || (k = r.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + r.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += k);
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        ...
                        for (h = 0; h < this._labels.length; h++) r = this._labels[h], r.position < this.viewportMinimum || (n = r.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + r.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += n);
            ...
            if ("bottom" === this._position) {
                ...
                for (h = 0; h < this._labels.length; h++) r = this._labels[h], r.position < this.viewportMinimum || r.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(r.position),
                    this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (q.x << 0) + 0.5 : q.x << 0, this.ctx.beginPath(), this.ctx.moveTo(b, q.y << 0), this.ctx.lineTo(b, q.y - this.tickLength << 0), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === r.textBlock.angle ? (q.x -= r.textBlock.width / 2, q.y = "inside" === this.labelPlacement ? q.y + this.labelFontSize / 2 + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - (("inside" === this.tickPlacement ?
                        ...
                        ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + ((r.textBlock.height - r.textBlock.fontSize / 2) * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? r.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))), r.textBlock.x = q.x, r.textBlock.y = q.y));
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (h = 0; h < a._labels.length; h++)
                        if (r = a._labels[h], !(r.position < a.viewportMinimum || r.position > a.viewportMaximum) &&
                            (q = a.getPixelCoordinatesOnAxis(r.position), a.tickThickness)) { a.ctx.lineWidth = a.tickThickness;
                ...
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (h = 0; h < a._labels.length; h++)
                        if (r = a._labels[h], !(r.position < a.viewportMinimum ||
                                r.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(r.position), a.tickThickness)) { a.ctx.lineWidth = a.tickThickness;
                ...
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (h = 0; h < a._labels.length; h++)
                        if (r =
                            a._labels[h], !(r.position < a.viewportMinimum || r.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(r.position), a.tickThickness)) { a.ctx.lineWidth = a.tickThickness;
                            a.ctx.strokeStyle = a.tickColor; var b = 1 === a.ctx.lineWidth % 2 ? (q.y << 0) + 0.5 : q.y << 0;
                            a.ctx.save();
                            a.ctx.beginPath();
                            a.ctx.moveTo(q.x << 0, b);
            ...
            f = 0;
            if ("inside" === this.labelPlacement) this.chart.addEventListener("dataAnimationEnd", function() { for (h = 0; h < a._labels.length; h++) r = a._labels[h], r.position < a.viewportMinimum || (r.position > a.viewportMaximum || d && 0 !== f++ % 2 && a.labelAutoFit) || (a.ctx.save(), a.ctx.beginPath(), r.textBlock.render(!0), a.ctx.restore()) }, this);
            else
                for (h = 0; h < this._labels.length; h++) r = this._labels[h],
        ...
        D.prototype.renderStripLinesOfThicknessType = function(a) {
            if (this.stripLines && 0 < this.stripLines.length && a) {
                for (var d = this, c, b = 0, e = 0, f = !1, k = !1, l = [], m = [], k = !1, b = 0; b < this.stripLines.length; b++) { var h = this.stripLines[b];
                ...
                if (!k) {
                    ...
                    this.ctx.clip();
                    for (b = 0; b < l.length; b++) h = l[b], h.showOnTop ?
                        f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() { this.ctx.save();
                            this.ctx.beginPath();
                            this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
                            this.ctx.clip(); for (e = 0; e < l.length; e++) h = l[e], h.showOnTop && h.render();
                            this.ctx.restore() }, h)) : h.render();
                    for (b = 0; b < m.length; b++) c = m[b], c.stripLine.showOnTop ? k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                ...
                if (k)
                    for (k = !1, b = 0; b < m.length; b++) c = m[b], c.stripLine.showOnTop ? k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
        ...
        D.prototype.createMask = function() {
            if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
                ...
                u ? (this.maskCanvas = ra(this.chart.width, this.chart.height), this.maskCtx = this.maskCanvas.getContext("2d")) : (this.maskCanvas = this.chart.plotArea.canvas, this.maskCtx = this.chart.plotArea.ctx);
                this.maskCtx.save();
            ...
            if (this.logarithmic) {
                ...
                if (c <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed)
                    for (c = 0; c < e.length; c++) {
                            ...
                            if (d)
                                if (e[c].startValue < this.conversionParameters.minimum) {
                                    if (1 < e[c].size && this.conversionParameters.minimum * Math.pow(e[c].endValue /
                                            e[c].startValue, Math.log(b) / Math.log(e[c].size)) < e[c].endValue) { a = Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)); break } else a *= e[c].endValue / this.conversionParameters.minimum / Math.pow(e[c].size, Math.log(e[c].endValue / this.conversionParameters.minimum) / Math.log(e[c].endValue / e[c].startValue)), b /= Math.pow(e[c].size, Math.log(e[c].endValue / this.conversionParameters.minimum) / Math.log(e[c].endValue / e[c].startValue));
                                    d = !1
                        ...
                        else if (b > e[c].startValue / e[c - 1].endValue) { b /= e[c].startValue / e[c - 1].endValue; if (b < e[c].size) { a *= Math.pow(e[c].endValue / e[c].startValue, 1 === e[c].size ? 1 : Math.log(b) / Math.log(e[c].size)) / b; break } else a *= e[c].endValue / e[c].startValue / e[c].size;
                            ...
                            if (!(e[c].startValue > this.conversionParameters.minimum))
                                if (d)
                                    if (e[c].endValue > this.conversionParameters.minimum) {
                                        ...
                                        d = !1
                                    } else if (b < e[c].endValue / this.conversionParameters.minimum) { b /= e[c].endValue / this.conversionParameters.minimum; if (b > 1 / e[c].size) { a *= Math.pow(e[c].endValue / e[c].startValue, 1 >= e[c].size ? 1 : Math.log(b) / Math.log(e[c].size)) * b; break } else a /= e[c].endValue / e[c].startValue / e[c].size;
                    b *= e[c].size;
                    d = !1 } else break;
                ...
                if (c <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed)
                    for (c = 0; c < e.length; c++) {
                        if (!(e[c].endValue < this.conversionParameters.minimum))
                            if (d)
                                if (e[c].startValue <
                                    this.conversionParameters.minimum) { if (e[c].size && this.conversionParameters.minimum + b * (e[c].endValue - e[c].startValue) / e[c].size < e[c].endValue) { a = 0 >= e[c].size ? 0 : b * (e[c].endValue - e[c].startValue) / e[c].size; break } else a += e[c].endValue - this.conversionParameters.minimum - e[c].size * (e[c].endValue - this.conversionParameters.minimum) / (e[c].endValue - e[c].startValue), b -= e[c].size * (e[c].endValue - this.conversionParameters.minimum) / (e[c].endValue - e[c].startValue);
                                    d = !1 } else if (b > e[c].startValue - this.conversionParameters.minimum) {
                            b -=
                                e[c].startValue - this.conversionParameters.minimum;
                        ...
                        else if (b > e[c].startValue - e[c - 1].endValue) { b -= e[c].startValue - e[c - 1].endValue; if (b < e[c].size) { a += (e[c].endValue - e[c].startValue) * (0 === e[c].size ? 1 : b / e[c].size) - b; break } else a += e[c].endValue - e[c].startValue - e[c].size;
                            b -= e[c].size } else break
                    } else
                        for (c = e.length - 1; 0 <= c; c--)
                            if (!(e[c].startValue >
                                ...
                                if (d)
                                    if (e[c].endValue > this.conversionParameters.minimum)
                                        if (e[c].size && this.conversionParameters.minimum + b * (e[c].endValue - e[c].startValue) / e[c].size > e[c].startValue) { a = 0 >= e[c].size ? 0 : b * (e[c].endValue - e[c].startValue) / e[c].size; break } else a += e[c].startValue - this.conversionParameters.minimum + e[c].size * (this.conversionParameters.minimum - e[c].startValue) / (e[c].endValue - e[c].startValue), b += e[c].size * (this.conversionParameters.minimum - e[c].startValue) / (e[c].endValue - e[c].startValue),
                                            d = !1;
            ...
            if (this.logarithmic) this.calculateLogarithmicAxisParameters();
                ...
                if ("axisX" === this.type && c) {
                    this.intervalType || (b / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : b / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : b / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : b / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") : b / 20 <= a ? (this.interval = 20, this.intervalType = "millisecond") : b / 50 <= a ? (this.interval = 50,
                        ...
                        a ? (this.interval = 3, this.intervalType = "week") : b / (1 * Q.monthDuration) <= a ? (this.interval = 1, this.intervalType = "month") : b / (2 * Q.monthDuration) <= a ? (this.interval = 2, this.intervalType = "month") : b / (3 * Q.monthDuration) <= a ? (this.interval = 3, this.intervalType = "month") : b / (6 * Q.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = b / (1 * Q.yearDuration) <= a ? 1 : b / (2 * Q.yearDuration) <= a ? 2 : b / (4 * Q.yearDuration) <= a ? 4 : Math.floor(D.getNiceNumber(b / (a - 1), !0) / Q.yearDuration), this.intervalType = "year"));
                    if (null ===
        ...
        D.prototype.calculateLogarithmicAxisParameters = function() {
            ...
            if (this.scaleBreaks)
                for (k = 0; k < this.scaleBreaks._appliedBreaks.length; k++)
                    if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >=
                            ...
                            this.viewportMaximum <= this.scaleBreaks._appliedBreaks[k].endValue)) { this.scaleBreaks._appliedBreaks.splice(k, 1); break }
            ...
            this.options && 0 < this.options.interval ? this.interval =
                this.options.interval : (this.interval = D.getNiceExponent(Math.log(k) / d / (a - 1), !0), c = D.getNiceNumber(l / (a - 1), !0));
            ...
            if (!this.options.interval &&
                this.range < Math.pow(this.logarithmBase, 8 > this.viewportMaximum || 3 > a ? 2 : 3)) { for (d = Math.floor(this.viewportMinimum / c + 0.5) * c; d < this.viewportMinimum;) d += c;
                this.equidistantInterval = !1;
                this.intervalStartPosition = d;
                this.interval = c } else this.options.interval || (c = Math.ceil(this.interval), this.range > this.interval && (this.interval = c, b = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (d * this.interval) + 0.2) * this.interval))), this.equidistantInterval = !0, this.intervalStartPosition = b;
            if (!this.valueFormatString &&
                (this.valueFormatString = "#,##0.##", 1 > this.viewportMinimum)) { d = Math.floor(Math.abs(Math.log(this.viewportMinimum) / Math.LN10)) + 2; if (isNaN(d) || !isFinite(d)) d = 2; if (2 < d)
        ...
        U.prototype.createUserOptions = function(a) {
            if ("undefined" !== typeof a || this.options._isPlaceholder) {
                ...
                this.options._isPlaceholder || (Aa(this.parent[this.optionsName]), d = this.parent.options[this.optionsName].indexOf(this.options));
        ...
        U.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                this.ctx.setLineDash &&
                    this.ctx.setLineDash(N(this.lineDashType, r));
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === r % 2 ? (b.x << 0) + 0.5 : b.x << 0, k = 1 === r % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + r / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - r / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b - r / 2, y1: e, x2: k + r / 2, y2: l }, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position &&
                        0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, l), this.ctx.lineTo(k, l), this.ctx.lineTo(k, e);
                    ...
                    if (e = 1 === r % 2 ? (e.y << 0) + 0.5 : e.y << 0, l = 1 === r % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, k = this.chart.plotArea.x2 + r / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, k = this.chart.plotArea.x1 - r / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: b,
                            y1: e - r /
                                2,
                            x2: k,
                    ...
                    f *= -1;
                    this.ctx.lineTo(m, h);
                    for (q = 0; q < n; q++) this.ctx.bezierCurveTo(m - a, h + f * a, m - 2 * a,
        ...
        M.prototype.createUserOptions =
            function(a) { if ("undefined" !== typeof a || this.options._isPlaceholder) { var d = 0;
                    this.parent.options._isPlaceholder && this.parent.createUserOptions();
                    this.options._isPlaceholder || (Aa(this.parent.stripLines), d = this.parent.options.stripLines.indexOf(this.options));
                    this.options = "undefined" === typeof a ? {} : a;
        ...
        M.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, k = this.chart.plotArea.y1, l = this.chart.plotArea.y2, this.bounds = { x1: e - d / 2, y1: k, x2: f + d / 2, y2: l };
        ...
        aa.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    else if ("left" === this.parent._position || "right" === this.parent._position) v =
                        this.parent.convertPixelToValue({ y: d });
                    for (var w = 0; w < this.parent.dataSeries.length; w++)(u = this.parent.dataSeries[w].getDataPointAtX(v, !0)) && 0 <= u.index && (u.dataSeries = this.parent.dataSeries[w], null !== u.dataPoint.y && n.push(u));
                    u = null;
                    ...
                    if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type)
                        for (var u = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y[0])),
                                t = 0, v = 0; v < n.length; v++)
                            if (n[v].dataPoint.y && n[v].dataPoint.y.length)
                                for (var x = 0; x < n[v].dataPoint.y.length; x++) t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
                            else t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y)), t < u && (u = t, w = v);
                    else if ("stackedBar" === n[0].dataSeries.type)
                        for (var u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), y = t = 0, v = w = 0; v < n.length; v++)
                            if (n[v].dataPoint.y && n[v].dataPoint.y.length)
                                for (x = 0; x < n[v].dataPoint.y.length; x++) t =
                                    Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
                            else y += n[v].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(y)), t < u && (u = t, w = v);
                    else if ("stackedBar100" === n[0].dataSeries.type)
                        for (var u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), C = y = t = 0, v = 0; v < n.length; v++)
                            if (n[v].dataPoint.y && n[v].dataPoint.y.length)
                                for (x = 0; x < n[v].dataPoint.y.length; x++) t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
                            else y += n[v].dataPoint.y,
                                C = n[v].dataPoint.x.getTime ? n[v].dataPoint.x.getTime() : n[v].dataPoint.x, C = 100 * (y / n[v].dataSeries.plotUnit.dataPointYSums[C]), t = Math.abs(a - this.parent.convertValueToPixel(C)), t < u && (u = t, w = v);
                    else
                        for (u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), v = w = t = 0; v < n.length; v++)
                            if (n[v].dataPoint.y && n[v].dataPoint.y.length)
                                for (x = 0; x < n[v].dataPoint.y.length; x++) t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
                            else t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y)),
                                t < u && (u = t, w = v);
                    x = n[w];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
                            ...
                            for (v = t = 0; v < x.dataPoint.y.length; v++) t = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[v])), t < u && (u = t, b = v);
                            ...
                            u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
                            y = t = 0;
                            for (v = w; 0 <= v; v--) y += n[v].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(y)), t < u && (u = t, b = v);
                            l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y) <<
                            ...
                            u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
                            C = y = t = 0;
                            for (v = w; 0 <= v; v--) y += n[v].dataPoint.y, C = n[v].dataPoint.x.getTime ? n[v].dataPoint.x.getTime() :
                                n[v].dataPoint.x, C = 100 * (y / n[v].dataSeries.plotUnit.dataPointYSums[C]), t = Math.abs(a - this.parent.convertValueToPixel(C)), t < u && (u = t, b = v);
                            l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(C) << 0) + 0.5 : this.parent.convertValueToPixel(C) << 0;
                            h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : C }) : s(this.options.label) ? ea(c ? c : C, this.valueFormatString, this.chart._cultureInfo) : this.label
                    ...
                    for (w = 0; w < this.parent.dataSeries.length; w++)(u = this.parent.dataSeries[w].getDataPointAtX(v, !0)) && 0 <= u.index && (u.dataSeries = this.parent.dataSeries[w], null !== u.dataPoint.y && n.push(u));
                    if (0 === n.length) return;
                    n.sort(function(a, b) { return a.distance - b.distance });
                    x = n[0];
                    ...
                    C = !1;
                    if (this.parent.labels)
                        for (n = Math.ceil(this.parent.interval), v = 0; v < this.parent.viewportMaximum; v += n)
                            if (this.parent.labels[v]) C = !0;
                            else { C = !1; break }
                    if (C) {
                        if ("axisX" === this.parent.type)
                            for (v = this.parent.convertPixelToValue({ x: a }), u = null, w = 0; w < this.parent.dataSeries.length; w++)(u = this.parent.dataSeries[w].getDataPointAtX(v, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) :
                    ...
                    !s(this.parent.dataSeries) &&
                        0 < this.parent.dataSeries.length && (v = this.parent.dataSeries[0].axisX.convertPixelToValue({ x: a }));
                    for (w = 0; w < this.parent.dataSeries.length; w++)(u = this.parent.dataSeries[w].getDataPointAtX(v, !0)) && 0 <= u.index && (u.dataSeries = this.parent.dataSeries[w], null !== u.dataPoint.y && n.push(u));
                    if (0 === n.length) return;
                    n.sort(function(a, b) { return a.distance - b.distance });
                    w = 0;
                    if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type ||
                        "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type || "boxAndWhisker" === n[0].dataSeries.type)
                        for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), v = t = 0; v < n.length; v++)
                            if (n[v].dataPoint.y && n[v].dataPoint.y.length)
                                for (x = 0; x < n[v].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
                            else t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y)), t < u && (u = t, w = v);
                    else if ("stackedColumn" === n[0].dataSeries.type || "stackedArea" ===
                        n[0].dataSeries.type)
                        for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), v = y = t = 0; v < n.length; v++)
                            if (n[v].dataPoint.y && n[v].dataPoint.y.length)
                                for (x = 0; x < n[v].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
                            else y += n[v].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(y)), t < u && (u = t, w = v);
                        ...
                        for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                            v = C = y = t = 0; v < n.length; v++)
                            if (n[v].dataPoint.y && n[v].dataPoint.y.length)
                                for (x = 0; x < n[v].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
                            else y += n[v].dataPoint.y, C = n[v].dataPoint.x.getTime ? n[v].dataPoint.x.getTime() : n[v].dataPoint.x, C = 100 * (y / n[v].dataSeries.plotUnit.dataPointYSums[C]), t = Math.abs(d - this.parent.convertValueToPixel(C)), t < u && (u = t, w = v);
                    else
                        for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), v = t = 0; v < n.length; v++)
                            if (n[v].dataPoint.y &&
                                n[v].dataPoint.y.length)
                                for (x = 0; x < n[v].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
                            else t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y)), t < u && (u = t, w = v);
                    x = n[w];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type ||
                        ...
                        for (v = t = 0; v < x.dataPoint.y.length; v++) t = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[v])), t < u && (u = t, b = v);
                        ...
                        y = t = 0;
                        for (v = w; 0 <= v; v--) y += n[v].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(y)), t < u && (u = t, b = v);
                        m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y) << 0) + 0.5 : this.parent.convertValueToPixel(y) <<
                            0;
                        h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y }) : s(this.options.label) ? ea(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        this.value = y
                        ...
                        u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y));
                        y = t = 0;
                        for (v = w; 0 <= v; v--) y += n[v].dataPoint.y, C = n[v].dataPoint.x.getTime ?
                            n[v].dataPoint.x.getTime() : n[v].dataPoint.x, C = 100 * (y / n[v].dataSeries.plotUnit.dataPointYSums[C]), t = Math.abs(d - this.parent.convertValueToPixel(C)), t < u && (u = t, b = v);
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) "top" === this.parent._position && h.y - h.fontSize / 2 < this.chart.bounds.y1 && (h.y = this.chart.bounds.y1 + h.fontSize / 2), "bottom" === this.parent._position && this.parent.lineCoordinates.y2 - h.fontSize / 2 + h.measureText().height > this.chart.bounds.y2 && (h.y = this.chart.bounds.y2 - h.height + h.fontSize / 2 + 2), b >= this.parent.convertValueToPixel(this.parent.viewportMinimum) && e <= this.parent.convertValueToPixel(this.parent.viewportMaximum) && (0 < r && (q.moveTo(b,
                    f), q.lineTo(e, k), q.stroke(), this._hidden = !1), q.restore(), !s(h.text) && ("number" === typeof h.text.valueOf() || 0 < h.text.length) && h.render(!0));
                if ("left" === this.parent._position || "right" === this.parent._position) "left" === this.parent._position && h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1), "right" === this.parent._position && h.x + h.measureText().width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.measureText().width), k >= this.parent.convertValueToPixel(this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.viewportMinimum) &&
                    (0 < r && (q.moveTo(b, f), q.lineTo(e, k), q.stroke(), this._hidden = !1), q.restore(), !s(h.text) && ("number" === typeof h.text.valueOf() || 0 < h.text.length) && h.render(!0))
            } else {
                ...
                else if ("left" === this.parent._position || "right" === this.parent._position) f = k = m = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2,
                    this.bounds = { x1: b, y1: f - r / 2, x2: e, y2: k + r / 2 };
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if (C) {
                            if ("axisX" === this.parent.type)
                                for (v = this.parent.convertPixelToValue({ y: d }), u = null, w = 0; w < this.parent.dataSeries.length; w++)(u = this.parent.dataSeries[w].getDataPointAtX(v, !0)) && 0 <= u.index &&
                                    (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) }) : s(this.options.label) ? u.dataPoint.label : this.label)
                        } else "dateTime" === this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(d) }) : s(this.options.label) ? ya(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) :
                            this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(d) }) : s(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    if (this.parent.labels)
                        for (n = Math.ceil(this.parent.interval),
                            v = 0; v < this.parent.viewportMaximum; v += n)
                            if (this.parent.labels[v]) C = !0;
                            else { C = !1; break }
                    if (C) { if ("axisX" === this.parent.type)
                            for (v = this.parent.convertPixelToValue({ x: a }), u = null, w = 0; w < this.parent.dataSeries.length; w++)(u = this.parent.dataSeries[w].getDataPointAtX(v, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) }) : s(this.options.label) ? c ? c : u.dataPoint.label : this.label) } else "dateTime" ===
                        this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) }) : s(this.options.label) ? ya(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
        ...
        $.prototype.mouseMoveHandler = function(a, d) { this._lastUpdated && 4 > (new Date).getTime() - this._lastUpdated || (this._lastUpdated = (new Date).getTime(), this.chart.resetOverlayedCanvas(), this._updateToolTip(a, d)) };
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var m = 0; m < this.chart.axisX.length; m++) {
                                for (var k =
                                        this.chart.axisX[m].convertPixelToValue({ y: d }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)(h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b], null !== h.dataPoint.y && l.push(h));
                                h = null
                            }
                        if (this.chart.axisX2)
                            for (m = 0; m < this.chart.axisX2.length; m++) {
                                ...
                                h = null;
                                for (b = 0; b < this.chart.axisX2[m].dataSeries.length; b++)(h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index &&
                                    (h.dataSeries = this.chart.axisX2[m].dataSeries[b], null !== h.dataPoint.y && l.push(h));
                                h = null
                            }
                    } else {
                        l = [];
                        if (this.chart.axisX)
                            for (m = 0; m < this.chart.axisX.length; m++)
                                for (k = this.chart.axisX[m].convertPixelToValue({ x: a }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)(h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b], null !== h.dataPoint.y && l.push(h));
                        if (this.chart.axisX2)
                            for (m = 0; m < this.chart.axisX2.length; m++)
                                for (k = this.chart.axisX2[m].convertPixelToValue({ x: a }),
                    ...
                    if (h = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = h.dataPointIndex, this.currentSeriesIndex =
                        ...
                        if (h = Wa(a, d, this.chart._eventManager.ghostCtx), 0 < h && "undefined" !== typeof this.chart._eventManager.objectMap[h]) { h = this.chart._eventManager.objectMap[h]; if ("legendItem" === h.objectType) return;
        ...
        $.prototype.getToolTipInnerHTML = function(a) {
            ...
            for (var d = null, c = null, b = null, e = 0, f = "", k = !0, l = 0; l < a.length; l++)
                if (a[l].dataSeries.toolTipContent ||
                    a[l].dataPoint.toolTipContent) { k = !1; break }
            if (k && (this.content && "function" === typeof this.content || this.contentFormatter)) a = { chart: this.chart, toolTip: this.options, entries: a }, d = this.contentFormatter ? this.contentFormatter(a) : this.content(a);
                ...
                for (var m = null, h = "", l = 0; l < a.length; l++) c = a[l].dataSeries, b = a[l].dataPoint, e = a[l].index, f = "", 0 === l && (k && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? h += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ?
